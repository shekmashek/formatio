...
select
lieu,projet_id,nom_projet,groupe_id,module_id,nom_module,nom_groupe
    from
    v_detail_groupe_module_projet,projets
    where
    projet_id = projets.id
    group by
    lieu,projet_id,groupe_id,module_id,nom_module,nom_groupe,nom_projet;
...
insert into objectif_globaux values(1,"Se perfectionner et élargir ses connaissances sur Excel",1,2,NULL,NULL);
insert into objectif_globaux values(2,"Maîtriser les techniques de calculs (avancés) qu’importe la difficulté et la complexité des formules",1,2,NULL,NULL);
insert into objectif_globaux values(3,"Être en mesure de concevoir et analyser les données",1,2,NULL,NULL);
insert into objectif_globaux values(4,"Gagner du temps et augmenter sa productivité",1,2,NULL,NULL);

insert into objectif_globaux values(5,"Acquérir les fondamentaux sine qua non à la bonne pratique d’utilisation du logiciel Microsoft Excel.",2,2,NULL,NULL);
insert into objectif_globaux values(6,"Savoir créer et comprendre une formule qu’importe la complexité et la longueur",2,2,NULL,NULL);
insert into objectif_globaux values(7,"Organiser et synthétiser les données.",2,2,NULL,NULL);

insert into objectif_globaux values(8,"Acquérir les fondamentaux de la transformation et de l’automatisation des tâches avec Power QueryAcquérir les fondamentaux sine qua non à la bonne pratique d’utilisation du logiciel Microsoft Excel.",3,2,NULL,NULL);
...
insert into objectif_pedagogique values(1,"Formation présentielle et en ligne",1,2,NULL,NULL);
insert into objectif_pedagogique values(2,"Apport de connaissance théorique",1,2,NULL,NULL);
insert into objectif_pedagogique values(3,"Alternance théorie/pratique",1,2,NULL,NULL);
insert into objectif_pedagogique values(4,"Mode opératoire",1,2,NULL,NULL);
insert into objectif_pedagogique values(5,"Exercices de mise en pratique",1,2,NULL,NULL);
insert into objectif_pedagogique values(6,"Quiz de révision",1,2,NULL,NULL);
insert into objectif_pedagogique values(7,"Questions/réponses",1,2,NULL,NULL);
insert into objectif_pedagogique values(8,"Support numérique Excel et Pdf",1,2,NULL,NULL);

insert into objectif_pedagogique values(9,"Un ordinateur pour chaque apprenant",2,2,NULL,NULL);
insert into objectif_pedagogique values(10,"Logiciel Excel, au minimum une version 2016",2,2,NULL,NULL);
insert into objectif_pedagogique values(11,"Un cahier et un stylo pour chacun d’eux.",2,2,NULL,NULL);
insert into objectif_pedagogique values(12,"Un vidéo projecteur",2,2,NULL,NULL);
...
insert into conclusion values(1,"Les participants souhaitent pouvoir assister davantage à d’autres modules de formation EXCEL pour ne rien rater des astuces, des méthodes et tactiques. L’atmosphère de la formation a été également conviviale et agréable.",2,NULL,NULL);
...
insert into evaluation_resultat values(1,"Tous les participants sont satisfaits de la formation.",2,NULL,NULL);
insert into evaluation_resultat values(2,"Globalement cette formation a répondu aux attentes des participants",2,NULL,NULL);
insert into evaluation_resultat values(3,"Le module traité pendant la formation a répondu aux attentes.",2,NULL,NULL);
insert into evaluation_resultat values(4,"Les méthodologies pédagogiques étaient adaptées, les présentations étaient claires,",2,NULL,NULL);
insert into evaluation_resultat values(5,"La théorie et la pratique étaient équilibrées, le rythme des cours était adéquat, la durée de la formation était trop juste.",2,NULL,NULL);
...
insert into detail_recommandation values(1,"Les participants souhaitent la continuité de la formation.",1,2,NULL,NULL);

insert into detail_recommandation values(2,"Il faut éviter les absences. Car qu’on est absent, on ne peut plus suivre efficacement le cours.",2,2,NULL,NULL);
insert into detail_recommandation values(3,"Il est plus facile pour les participants de renforcer leurs compétences si les matériels utilisés lors des études de cas, proviennent vraiment de leurs fichiers de travail actuels.",2,2,NULL,NULL);
...
insert into detail_evaluation_action_formation values(1,90,1,2,NULL,NULL);
insert into detail_evaluation_action_formation values(2,96,2,2,NULL,NULL);
insert into detail_evaluation_action_formation values(3,84,3,2,NULL,NULL);
insert into detail_evaluation_action_formation values(4,94,4,2,NULL,NULL);

create or replace view v_evaluation_action_formation as
select
        (evaluation_action_formation.id) action_formation_id , titre,pourcent,projet_id
from
