...
<div class="container-fluid pt-4">
    {{-- <div class="row "> --}}
        <div class="d-flex flex-row justify-content-between">
            <div><h5>Les Organismes de Formations près de chez vous</h5></div>
            <div class="d-flex flex-row">
                ...
                @if(isset($nom_entiter))
                    ...
                    @elseif ($pagination["debut_aff"] == 1)
                        <a href="{{ route('annuaire+recherche+par+entiter',[($pagination[" debut_aff"] - $pagination["nb_limit"]),$nom_entiter ])}}" role="button" style=" pointer-events: none;cursor: default;"><i class='bx bx-chevron-left pagination pt-1'></i></a>
                ...
                @else
                    ...
                    @if ($pagination["fin_aff"] >= $pagination["totale_pagination"])
                        <a href="{{ route('annuaire',$pagination["debut_aff"] - $pagination["nb_limit"]) }}" role="button"><i class='bx bx-chevron-left pagination pt-1'></i></a>
                        <a href="{{ route('annuaire',$pagination["debut_aff"] + $pagination["nb_limit"]) }}" role="button" style=" pointer-events: none;cursor: default;"><i class='bx bx-chevron-right pagination pt-1'></i></a>
                    @elseif ($pagination["debut_aff"] == 1)
                        <a href="{{ route('annuaire',$pagination["debut_aff"] - $pagination["nb_limit"])}}" role="button" style=" pointer-events: none;cursor: default;"><i class='bx bx-chevron-left pagination pt-1'></i></a>
                        <a href="{{ route('annuaire',$pagination["debut_aff"] + $pagination["nb_limit"]) }}" role="button"><i class='bx bx-chevron-right pagination pt-1'></i></a>
                    @elseif ($pagination["debut_aff"] < $pagination["totale_pagination"] && $pagination["debut_aff"]> 1)
                        <a href="{{route('annuaire',$pagination["debut_aff"] - $pagination["nb_limit"]) }}" role="button"><i class='bx bx-chevron-left pagination pt-1'></i></a>
                        <a href="{{  route('annuaire',$pagination["debut_aff"] + $pagination["nb_limit"]) }}" role="button"><i class='bx bx-chevron-right pagination pt-1'></i></a>
                    @else
                ...
                <div id="result">
                    ...
                    <div class="row detail_content mb-5">
                        <div class="col-2 logo_content">
                            <a href="{{route('detail_cfp',$cfp->id)}}"><img src="{{asset(" images/CFP/".$cfp->logo)}}"
                                alt="logo" class="img-fliud logo_img"></a>
                        </div>
                        <div class="col-10 ">
                            <div class="row">
                                ...
                                <div class="col d-flex flex-row mb-2">
                                    <span class="btn_actions ms-2" role="button"><a href="#"><i
                                                class="bx bx-mail-send"></i>Email</a></span>
                                    <span class="btn_actions ms-3 contact_action" role="button"
                                        data-bs-toggle="collapse" href="#contact_{{ $cfp->id }}" aria-expanded="false"
                                        aria-controls="collapseprojet"><i class="bx bx-phone"></i>Contact</span>
                                    <span class="btn_actions ms-3" role="button"><a href="https://{{$cfp->site_web}}"
                                            target="_blank"><i class="bx bx-globe"></i>Site
                                            Web</a></span>
                                    <span class="btn_actions ms-3" role="button"><a
                                            href="{{route('detail_cfp',$cfp->id)}}"><i
                ...
                <div class="row mt-0 navigation_module">
                    ...
                    <div class="collapse multi-collapse" id="search_num_fact">
                        <form class=" mt-1 mb-2 form_colab" method="GET"
                            ...
                            @csrf
                            <input name="nom_entiter" id="nom_entiter" required class="form-control" required
                                type="text" aria-label="Search" placeholder="nom d'organisme">
                    ...
                    <div class="collapse multi-collapse" id="detail_par_solde">
                        <form class="mt-1 mb-2 form_colab" action="{{route('annuaire+recherche+par+adresse')}}"
                            ...
                            <br>
                            <label for="dte_fin" class="form-label" align="left">ville <strong
                                    style="color:#ff0000;">*</strong></label>
                            <input required type="text" name="vlle" id="vlle" class="form-control" />

                            <label for="dte_fin" class="form-label" align="left">code postale <strong
                                    style="color:#ff0000;">*</strong></label>
                            <input required type="text" name="cde_post" id="cde_post" class="form-control" />

                            <label for="dte_fin" class="form-label" align="left">région<strong
                                    style="color:#ff0000;">*</strong></label>
