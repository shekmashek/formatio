        ...
        <div class="row justify-content-space-between py-3 " id="border_premier">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="detail__formation__result__item2">
                    ...
                    <div class="text-center"><img src="{{asset('images/entreprises/'.$res->logo)}}" alt="logo" class="img-fluid"
            ...
            <div class="row row-cols-auto mt-3 liste__formation__result__item3 justify-content-space-between ">
                <div id="objectif"></div>
...
<script src="{{ asset('js/module_interne.js') }}"></script>
<script>
