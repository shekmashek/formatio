                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th>
                                        <select name="" class="form-control nom" id="nom" style="width: 100px;height:30px;font-size:12px" id="">
                                            {{-- @foreach($employer as $em)
                                    ...
                                    <th>
                                        <select name="" class="form-control fonction" id="fonction" style="width: 100px;height:30px;font-size:12px" id="">
                                            {{-- @foreach($employer as $em)
                                    ...
                                    <th>
                                        <select name="" class="form-control departementC" id="departementC" style="width: 160px;height:30px;font-size:12px" id="">
                                            {{-- @foreach($employer as $em)
                                    ...
                                    <th>
                                        <select name="" class="form-control service" id="service" style="width: 100px;height:30px;font-size:12px" id="">
                                            {{-- @foreach($employer as $em)
                                            <option value="" >{{$em->nom_emp}}</option>
                                            @endforeach --}}
                                        </select>
                                    ...
                                    <th>
                                        <select name="" class="form-control domaine" style="width: 150px;height:30px;font-size:12px" id="">
                                    ...
                                    <th>
                                        <select name="" class="form-control thematique" id="thematique" style="width: 150px;height:30px;font-size:12px" id="">
                                            {{-- @foreach($employer as $em)
                                            <option value="" >{{$em->nom_emp}}</option>
                                            @endforeach --}}
                                        </select>
                                    </th>
                                    <th><input type="date" style="width: 100px;height:30px;font-size:12px" class="form-control"></th>
                                    <th><input style="width: 100px;height:30px;font-size:12px" type="text" class="form-control"></th>
                                    <th>
                                        <select name="" class="form-control" style="width: 150px;height:30px;font-size:12px" id="">
                                            <option value="" >urgent</option>
                                            <option value="" >non-urgent</option>    
                                        </select>
                                    </th>
                                    <th><button class="btn btn-info text-light" style="width: 90px;height:30px;font-size:12px">Ajouter</button></th>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                success: function (response) {
                    ...
                    if (employer.length > 0) {
                        ...
                        for(var i = 0;i < employer.length ; i++){
                            $(".nom").append(
                                '<option value="'+employer[i].nom_emp+'">'+employer[i].nom_emp+'</option>'
                            )
                            
                            $(".fonction").append(
                                '<option value="'+employer[i].fonction_emp+'">'+employer[i].fonction_emp+'</option>'
                            )

                            $(".departementC").append(
                                '<option value="'+employer[i].nom_departement+'">'+employer[i].nom_departement+'</option>'
                            )
                            $(".service").append(
                                '<option value="'+employer[i].nom_service+'">'+employer[i].nom_service+'</option>'
                            )
                        }
                    }else{
