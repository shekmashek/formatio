                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            @foreach($module as $mod)
                                            @if($mod->thematique_id == $mo->thematique_id)
                                                <input type="text" style="height:30px"  value="{{$mod->v}}" name="prev{{$mo->thematique_id}}"  class="form-control text-end" disabled>
                            ...
                            <td>
                                @foreach($besoin as $be)   
                                    @if ($be->stagiaire_id == $st->stagiaire_id)  
                                        ...
                                        <input style="height: 30px" type="text"  value="300000" name="cout_{{$be->id}}" class="form-control text-end">
