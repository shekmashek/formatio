...
<div class="p-1 m-0 mt-1">
    <div class="container-fluid" style="font-size: 11.8px;">
        ...
        <div class="row mt-2">
            <div class="col-lg-4">
                <div class="shadow-sm p-2 mb-1 bg-body rounded" style="color: #8d8d8d;height:151px"><b> <i class="fas fa-users "></i>&nbsp; Collaborateur </b>
            ...
            <div class="col-lg-4">
                <div class="shadow-sm p-2 mb-1 bg-body rounded" style="color: #8d8d8d;height:151px"><b> <i class="fas fa-book"></i> &nbsp; Catalogue </b>
        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-4">
                <div class="shadow-sm p-2 mb-1 bg-body rounded" style="color: #8d8d8d;"><b> <i class="fas fa-tasks"></i> &nbsp; Session Inter entreprise </b>
                    <a class="overr" href=""><p class="p-0 m-1 system_ pb-1">Complété<span class="system_numero">{{count($session_inter_terminer)}}</span></p></a>
