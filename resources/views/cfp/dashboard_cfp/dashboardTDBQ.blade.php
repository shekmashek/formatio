...
<div class=" p-0 m-0 nav d-flex flex-row navigation justify-content-end" style="font-size: 10px;">
        ...
        <a href="{{ route('hometdbq')}}" type="button" class="btn c active" style="font-size: 12px;"> <i class="fas fa-chart-line" style="font-size: 10px;"></i>&nbsp;TDB qualité</a>
</div>
    ...
    <div class="container-fluid">
        <div class="row mt-2">
            ...
            <div class="col-lg-4">
                <div class="form-control" >
                    {{-- graphique --}}
                    <p class="text-center" style="font-size: 13px; color:#7535DC">Total d'heure par département</p>
        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-4">
                <div class="form-control">
                    {{-- graphique --}}
                    <p class="text-center" style="font-size: 13px; color:#7535DC">Nombre de la personne formé par entreprise</p>
        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-4">
                <div class="form-control">
                    <p class="text-center" style="font-size: 13px; color:#7535DC">Total homme et femme</p>
                    <span class="ms-5 mt-1" style="color: rgb(82, 82, 82)"><i class="fas fa-male" style="color:rgb(138, 154, 243);background-color: rgb(197, 204, 243); border-radius: 7px; font-size: 26px; padding: 5px;width:26px"></i>&nbsp;&nbsp; 10 hommes</span>
                    <span class="ms-5 mt-1" style="color: rgb(82, 82, 82)"><i class="fas fa-female" style="color:rgb(238, 144, 149);background-color: rgb(243, 197, 199); border-radius: 7px; font-size: 26px; padding: 5px;width:26px"></i>&nbsp;&nbsp; 5 femmes</span>
                </div>
            </div>
