            ...
            <div class="row">
                ...
                <div class="col-8">
                    <div>
                        ...
                        @endif
                            <a href="{{route('modification_nom_organisme',$cfps->id)}}" class="action_name_modif text-white">Modifier</a>
                    </div>
                </div>
            </div>
        ...
        <h5 class="text-center mb-5">Information Professionnelles</h5>
            <div class="row border_bas">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bxl-gmail icon_sociaux1'></i>&nbsp;{{$cfps->email}}</p><p class="text-end"><a href="{{route('modification_email',$cfps->id)}}" ><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row border_bas mt-3">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bx-phone icon_sociaux1'></i>&nbsp;{{$cfps->telephone}}</p><p class="text-end"><a href="{{route('modification_telephone',$cfps->id)}}" ><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row border_bas mt-3">
                <div class="col">
                    @if($reseaux_sociaux != null)
                        ...
                        @else
                            <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bxl-facebook-circle icon_sociauxf'></i>&nbsp;{{$reseaux_sociaux[0]->lien_facebook}}</p><p class="text-end"><a href="{{route('lien_facebook',$cfps->id)}}" ><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                        @endif
                    @else
            ...
            <div class="row border_bas mt-3">
                <div class="col">
                    @if($reseaux_sociaux != null)
                        ...
                        @else
                            <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bxl-twitter icon_sociauxtwt'></i>&nbsp;{{$reseaux_sociaux[0]->lien_twitter}}</p><p class="text-end"><a href="{{route('lien_twitter',$cfps->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                        @endif
                    @else
            ...
            <div class="row border_bas mt-3">
                <div class="col">
                    @if($reseaux_sociaux != null)
                        ...
                        @else
                            <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bxl-instagram-alt icon_sociauxist'></i>&nbsp;{{$reseaux_sociaux[0]->lien_instagram}}</p><p class="text-end"><a href="{{route('lien_instagram',$cfps->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                        @endif
                    @else
            ...
            <div class="row mt-3">
                <div class="col">
                    @if($reseaux_sociaux != null)
                        ...
                        @else
                            <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bxl-linkedin-square icon_sociauxin'></i>&nbsp;{{$reseaux_sociaux[0]->lien_linkedin}}</p><p class="text-end"><a href="{{route('lien_linkedin',$cfps->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                        @endif
                    @else
        ...
        <div class="col-4 info_plus2 p-5 pt-4">
            ...
            <div class="row border_bas">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bxs-map icon_sociaux2'></i>&nbsp;{{$cfps->adresse_lot}}&nbsp;{{$cfps->adresse_quartier}}</p><p class="text-end"><a href="{{route('modification_adresse_organisme',$cfps->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row border_bas mt-3">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bxs-map-pin icon_sociaux2'></i>&nbsp;{{$cfps->adresse_ville}}</p><p class="text-end"><a href="{{route('modification_adresse_organisme',$cfps->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row border_bas mt-3">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bx-map-alt icon_sociaux2'></i>&nbsp;{{$cfps->adresse_region}}</p><p class="text-end"><a href="{{route('modification_adresse_organisme',$cfps->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row mt-3">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bx-globe icon_sociaux2'></i>&nbsp;{{$cfps->site_web}}</p><p class="text-end"><a href="{{route('modification_site_web',$cfps->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row mt-3">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bx-sitemap icon_sociaux3'></i>NIF :&nbsp;{{$cfps->nif}}</p><p class="text-end"><a href="{{route('modification_nif',$cfps->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row mt-3">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bx-align-justify icon_sociaux3'></i>STAT :&nbsp;{{$cfps->stat}}</p><p class="text-end"><a href="{{route('modification_stat',$cfps->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row mt-3">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bxs-check-shield icon_sociaux3'></i>RCS :&nbsp;{{$cfps->rcs}}</p><p class="text-end"><a href="{{route('modification_rcs_cfps',$cfps->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row mt-3">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bx-check-shield icon_sociaux3'></i>CIF :&nbsp;{{$cfps->cif}}</p><p class="text-end"><a href="{{route('modification_cif_cfps',$cfps->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
        </div>
            ...
            <div class="row border_bas">
                <div class="col text-center afficher_icon_modif">
                    ...
                    @elseif($cfps->assujetti_id == 1)
                        <div class="p-1 m-0"><p>Assujetti</p></div>
                        <div><p ><a href="{{route('modification_assujetti_cfp',$cfps->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @else
                        <div class="p-1 m-0"><p>Non Assujetti</p></div>
                        <div><p class="text-center"><a href="{{route('modification_assujetti_cfp',$cfps->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row border_bas">
            ...
            <div class="row">
                <div class="col text-center afficher_icon_modif">
                    ...
                    @else
                        ...
                        @endfor
                        <div class="mt-3"><p class="text-center"><a href="{{route('modification_horaire',$cfps->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
        </div>
