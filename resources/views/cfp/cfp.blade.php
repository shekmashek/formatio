    ...
    <div class="container-fluid mt-4 p-5 ">
        <ul class="nav nav-tabs mb-3 navigation_module" id="myTab" role="tablist">
            <li class="nav-item active" id="collabore-tab" role="presentation">
                <a class="nav-link active collabore" id="ex1-tab-1" data-mdb-toggle="tab" data-toggle="tab" href="#collabore" role="tab" aria-controls="ex1-tabs-1" aria-selected="true"><i class="bi bi-wallet-fill"></i>&nbsp;&nbsp;EN COLABORATION</a>
            </li>
            <li class="nav-item" id="invitation-tab" role="presentation">
                <a class="nav-link invitation" id="ex1-tab-2" data-mdb-toggle="tab" data-toggle="tab" href="#invitation   " role="tab" aria-controls="ex1-tabs-2" aria-selected="false"><i class="bi bi-person-plus-fill"></i>&nbsp;&nbsp;INVITATION</a>
            </li>
        ...
        <div class="tab-content" id="ex1-content">
            <div class="tab-pane tab-pane fade show active" id="collabore" role="tabpanel" aria-labelledby="ex1-tab-1">
            ...
            <div class="row mt-2 ">
                <div class="col-md-4">
                    ...
                    <form class="form form_colab mt-3" action="{{ route('create_etp_cfp') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nom_cfp" required>
                        </div>
                        <div class="form-group mt-2">
                            <label for="">Email :</label>
                            <input type="email" class="form-control" name="email_cfp" required>
                        </div>
                ...
                <div class="col-md-8 ">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav navbar-nav navbar-list me-auto mb-2 mb-lg-0 d-flex flex-row nav_bar_list">
                                    <li class="nav-item">
                                        <a href="#" class="nav-link active " style="border-bottom: 3px solid black" id="home-tab" data-bs-toggle="tab" data-bs-target="#invitation_1" type="button" role="tab" aria-controls="invitation_1" aria-selected="true">
                                            Invitations en attentes @if(count($invitation)>0) {{count($invitation)}} @endif
                                        </a>
                                    </li>
                                    <li class="nav-item ms-5">
                                        <a href="#" class="nav-link" id="profile-tab" style="border-bottom: 3px solid black" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">
                                            Invitations réfuser @if(count($refuse_demmande_cfp)>0) {{count($refuse_demmande_cfp)}} @endif
                                        </a>
                                    </li>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="invitation_1" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <table class="table  table-borderless table-sm mt-4">
                                    <tbody id="data_collaboration">
                                        ...
                                        @if (count($invitation)<=0) <tr style="text-align:left">
                                            ...
                                            <tr>
                                                <td>
                                                    <span>{{$invit_cfp->nom_resp_cfp.' '.$invit_cfp->prenom_resp_cfp}}</span>
                                                    <p style="color: rgb(238, 150, 18)">{{$invit_cfp->email_resp_cfp}}</p>
                                                </td>
                                                <td>
                                                    <div align="left">
                                                        <strong>{{$invit_cfp->nom_cfp}}</strong>
                                                        <p style="color: rgb(126, 124, 121)"> <strong>{{$invit_cfp->slogan}}</strong></p>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="{{ route('accept_etp_cfp',$invit_cfp->id) }}">
                                                        <span>
                                                            <i class="bx bx-plus-medical bx_ajouter actions" title="Accepter"></i> accepter
                                                        </span>
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href="{{ route('annulation_etp_cfp',$invit_cfp->id) }}">
                                                        <span>
                                                            <i class="bx bx-trash bx_supprimer actions" title="Refuser"></i> réfuser
                                                        </span>
                                                    </a>
                                            </tr>
                                            @endforeach
                                ...
                                <table class="table  table-borderless table-sm mt-4">
                                    <tbody>
                                        @if (count($refuse_demmande_cfp)<=0) <tr style="text-align:left">
                                            ...
                                            <tr>
                                                <td>
                                                    <span>{{$refuse_invit->nom_resp_cfp.' '.$refuse_invit->prenom_resp_cfp}}</span>
                                                    <p style="color: rgb(238, 150, 18)">{{$refuse_invit->email_resp_cfp}}</p>
                                                </td>
                                                <td>
                                                    <span>{{$refuse_invit->nom}}</span>
                                                ...
                                                <td><a href="#">
                                                    <span>
                                                        <i class="bx bx-trash bx_supprimer actions" title="Refuser"></i>
                                                    </span>
                                                </a></td>
