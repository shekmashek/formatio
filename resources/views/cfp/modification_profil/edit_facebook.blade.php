...
@section('title')
    <h3 class="text_header m-0 mt-1">Modification facebook</h3>
@endsection
@section('content')
...
<center>
    ...
    <div class="col-lg-4">
        <div class="p-3 form-control">
            ...
            <form action="{{route('ajout_facebook',$id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row px-3 mt-4">
                    ...
                    @endif
                    <label class="form-control-placeholder ">Lien Facebook</label>
