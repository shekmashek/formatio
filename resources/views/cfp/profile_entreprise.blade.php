                ...
                <tbody id="data_collaboration" style="font-size: 15.5px;">
                    ...
                    @else
                        ...
                        <tr  class="information" data-id="{{$etp->entreprise_id}}" id="{{$etp->entreprise_id}}">
                            ...
                            <td role="button"  onclick="afficherInfos();"><img src="{{asset("images/entreprises/COLAS.png")}}" style="width: 40px;height: 40px;text-align:center;"><span class="ms-3">{{$etp->nom_etp}}</span></td>
                            <td role="button"  onclick="afficherInfos();">
                                <img src="{{asset("images/responsables/users.png")}}" style="height:40px; width:40px;border-radius:100%"><span class="ms-3">{{$etp->nom_resp}} {{$etp->prenom_resp}}</span>
                            </td>
                        <td>
