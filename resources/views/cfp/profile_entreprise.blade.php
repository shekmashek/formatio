...
@endif
    ...
    <ul class="nav nav-tabs mb-3" id="ex1" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" id="ex1-tab-1" data-mdb-toggle="tab" data-bs-toggle="tab" href="#ex1-tabs-1" role="tab" aria-controls="ex1-tabs-1" aria-selected="true"><i class="bi bi-wallet-fill"></i>&nbsp;&nbsp;EN COLABORATION</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link " id="ex1-tab-2" data-mdb-toggle="tab" data-bs-toggle="tab" href="#ex1-tabs-2" role="tab" aria-controls="ex1-tabs-2" aria-selected="false"><i class="bi bi-person-plus-fill"></i>&nbsp;&nbsp;INVITATION</a>
        </li>
    </ul>
                ...
                <div class="col-md-4">
                    ...
                    <form class="form form_colab mt-3" action="{{ route('create_cfp_etp') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input autocomplete="off" type="text" class="form-control" name="nom_resp" required>
                        </div>
                        <div class="form-group mt-2">
                            <label for="">Email :</label>
                            <input autocomplete="off" type="email" class="form-control" name="email_resp" required>
                        </div>
                                ...
                                <ul class="nav navbar-nav navbar-list me-auto mb-2 mb-lg-0 d-flex flex-row nav_bar_list">
                                    <li class="nav-item">
                                        <a href="#" class="nav-link active " style="border-bottom: 3px solid black" id="home-tab" data-bs-toggle="tab" data-bs-target="#invitation" type="button" role="tab" aria-controls="invitation" aria-selected="true">
                                            Invitations en attentes @if(count($invitation_etp)>0) {{count($invitation_etp)}} @endif
                                        </a>
                                    </li>
                                    <li class="nav-item ms-5">
                                        <a href="#" class="nav-link" id="profile-tab" style="border-bottom: 3px solid black" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">
                                            Invitations réfuser @if(count($refuse_demmande_etp)>0) {{count($refuse_demmande_etp)}} @endif
                                        </a>
                                    </li>
                                ...
                                <table class="table  table-borderless table-sm mt-4">
                                    <tbody id="data_collaboration">
                                        ...
                                        @if (count($invitation_etp)<=0) <tr style="text-align:left">
                                            ...
                                            <tr>
                                                <td>
                                                    <span>{{$invit_etp->nom_resp.' '.$invit_etp->prenom_resp}}</span>
                                                    <p style="color: rgb(238, 150, 18)">{{$invit_etp->email_resp}}</p>
                                                </td>
                                                <td>
                                                    <span>{{$invit_etp->nom_etp}}</span>
                                ...
                                <table class="table  table-borderless table-sm mt-4">
                                    <tbody>
                                        @if (count($refuse_demmande_etp)<=0) <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <span>{{$refuse_invit->nom_resp.' '.$refuse_invit->prenom_resp}}</span>
                                                    <p style="color: rgb(238, 150, 18)">{{$refuse_invit->email_resp}}</p>
                                                </td>
                                                <td>
                                                    <span>{{$refuse_invit->nom_etp}}</span>
