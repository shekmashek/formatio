...
@section('content')
    ...
    <div class="card shadow mx-3 my-3 px-3 pt-3">
        <i class="far fa-caret-circle-down pb-3" data-toggle="collapse" href="#corps" role="button" aria-expanded="false"><a
                data-toggle="collapse" href="#corps" role="button" aria-expanded="false" aria-controls="collapseExample">
                Janvier </a> </i>
        <div class="collapse" id="corps">

            <div class="d-flex justify-content-end mb-3 me-2">
                <i class="fa fa-folder-plus ms-2" style="font-size: 22px; color:rgb(130,33,100);">&nbsp;<a
                        class="m-0 p-0" style="font-size: 16px;"> Ajouter un nouveau projet </a></i>
            </div>
