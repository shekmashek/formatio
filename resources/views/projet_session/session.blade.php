    ...
    <nav class="body_nav m-0">
                ...
                @canany(['isCFP'])
                    <div class="chiffre_d_affaire">
                        <div class="d-flex flex-row">
                            ...
                            <img src="{{ asset('images/formateurs/' . $form->photos) }}" alt="" class="img_superpose mt-2" height="30px" width="30px" style="border-radius: 50%;margin-top: 1.6rem !important">
                            @endforeach()
                        </div>
                        </strong></p>
                    </div>
        ...
        <div class="col-md-3 d-flex justify-content-end">
            ...
            <div class="dropdown">
                ...
                <a class="dropdown-toggle btn_modifier_statut" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false" aria-haspopup="true" style="text-decoration: none">
...
<section>
        ...
        <div class="col-md-2 nav_session">
            <div class="corps_planning m-0 bg-light" id="myTab" data-id="refresh" role="tablist">
                <div class="nav-item active" role="presentation">
                    <a href="#detail" class="nav-link active p-0" id="detail-tab" data-toggle="tab" type="button" role="tab" aria-controls="home" aria-selected="true">
                        <button class="planning d-flex justify-content-between active detail-tab
                                @can('isCFP') {{ 'action_animation' }} @endcan" onclick="openCity(event, 'detail')" style="width: 100%">
                ...
                <div class="nav-item" role="presentation">
                    <a href="#apprenant" class="nav-link p-0" id="apprenant-tab" data-toggle="tab" type="button" role="tab" aria-controls="home" aria-selected="true">
                ...
                <div class="nav-item" role="presentation">
                    <a href="#frais" class="nav-link p-0" id="frais-tab" data-toggle="tab" type="button" role="tab" aria-controls="home" aria-selected="true">
                        <button class="planning d-flex justify-content-between action_animation frais-tab" onclick="openCity(event, 'frais')" style="width: 100%">
                            <p class="m-0 pt-2 pb-2">FRAIS ANNEXES</p>
                            @if (count($all_frais_annexe) <= 0) <i class="fal fa-dot-circle me-2 mt-2" style="color: grey"></i>
                                @else
                                <i class="fa fa-check-circle me-2 mt-2" style="color: chartreuse"></i>
                                @endif
                        </button>
            ...
            @canany(['isStagiaire'])
            <div class="nav-item" role="presentation">
                <a href="#chaud" class="nav-link p-0" id="chaud-tab" data-toggle="tab" type="button" role="tab" aria-controls="home" aria-selected="true">
                    <button class="planning d-flex justify-content-between chaud-tab" onclick="openCity(event, 'chaud')" style="width: 100%">
            ...
            @can('isFormateur')
            <div class="nav-item" role="presentation">
                <a href="#emargement" class="nav-link p-0" id="emargement-tab" data-toggle="tab" type="button" role="tab" aria-controls="home" aria-selected="true">
                    <button class="planning d-flex justify-content-between action_animation emargement-tab" onclick="openCity(event, 'emargement')" style="width: 100%">
            ...
            <div class="nav-item" role="presentation">
                <a href="#evaluation" class="nav-link p-0" id="evaluation-tab" data-toggle="tab" type="button" role="tab" aria-controls="home" aria-selected="true">
                    <button class="planning d-flex justify-content-between  action_animation evaluation-tab" onclick="openCity(event, 'evaluation')" style="width: 100%">
                        <p class="m-0 pt-2 pb-2">PRE EVALUATION</p>
                        @if ($evaluation_avant <= 0) <i class="fal fa-dot-circle me-2 mt-2" style="color: grey"></i>
                        @else
                        <i class="fa fa-check-circle me-2 mt-2" style="color: chartreuse"></i>
                        @endif
                    </button>
            ...
            <div class="nav-item" role="presentation">
                <a href="#evaluation_pre_formation" class="nav-link p-0" id="evaluation_pre_formation-tab" data-toggle="tab" type="button" role="tab" aria-controls="home" aria-selected="true">
                    <button class="planning d-flex justify-content-between action_animation evaluation_pre_formation-tab" onclick="openCity(event, 'evaluation_pre_formation')" style="width: 100%">
                        <p class="m-0 pt-2 pb-2">EVALUATION</p>
                        @php
            ...
            <div class="nav-item" role="presentation">
                <a href="#evaluation_pre_formation" class="nav-link p-0" id="evaluation_pre_formation-tab" data-toggle="tab" type="button" role="tab" aria-controls="home" aria-selected="true">
                    <button class="planning d-flex justify-content-between evaluation_pre_formation-tab" onclick="openCity(event, 'evaluation_pre_formation')" style="width: 100%">
                        <p class="m-0 pt-2 pb-2">EVALUATION</p>
                        @php
                        $statut_eval = $groupe->statut_evaluation($projet[0]->groupe_id);
                        if ($statut_eval == 0) {
    ...
    <div class="tab-content col-md-10">
        ...
        <div class="tab-pane fade show active tabcontent" id="detail" role="tabpanel" aria-labelledby="detail-tab" style="display: block">
        ...
        <div class="tab-pane fade show tabcontent" id="apprenant" role="tabpanel" aria-labelledby="apprenant-tab" style="display: none">
            @include('admin.stagiaire.ajout_stagiaire')
        </div>
        @endcanany

        <div id="ressource" class="tab-pane fade show tabcontent" id="ressource" role="tabpanel" aria-labelledby="ressource-tab" style="display: none">
            @include('projet_session.ressource')
        </div>
        <div id="frais" class="tab-pane fade show tabcontent" id="frais" role="tabpanel" aria-labelledby="frais-tab" style="display: none">
        ...
        @canany(['isStagiaire'])
        <div id="chaud" class="tab-pane fade show tabcontent" role="tabpanel" aria-labelledby="document-tab" style="display: none">
            {{-- @include('projet_session.index_evaluation') --}}
            @include('admin.evaluation.evaluationChaud.evaluationChaud')
        </div>
        @endcanany
        <div id="emargement" class=" tab-pane fade show tabcontent" role="tabpanel" aria-labelledby="emargement-tab" style="display: none">
            @include('projet_session.emargement')
        </div>
        <div id="evaluation" class=" tab-pane fade show tabcontent" role="tabpanel" aria-labelledby="evaluation-tab" style="display: none">
            @include('projet_session.evaluation_stagiaires')
        </div>
        <div id="evaluation_pre_formation" class="tab-pane fade show tabcontent" role="tabpanel" aria-labelledby="evaluation_pre_formation-tab" style="display: none">
            ...
            $.ajax({
                ...
                , success: function(response) {
                    ...
                    for (let i = 0; i < userData.length; i++) {
                        let logo =
                            '<img src="{{ asset('
                        images / entreprises /: url_img ') }}" style="width:120px;height:120px;border-radius:100%">';
