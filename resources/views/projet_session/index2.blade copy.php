        ...
        @canany(['isCFP'])
            ...
            <table class="table order-column  modifTable "  id="example">
                ...
                <thead  style="position: sticky; top: 0;">
                    <tr style="background: #d4d1d1;margin-top:-10px;">
                        <th class="test">
                            <div class="dropend proJR">
                                <button style="font-size: 13px" class="btn btn-default dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="bx bx-library align-middle" style="color: #2e3950"></i> Projet
                                </button>
                                <ul class="dropdown-menu main p-2 overflow-auto" style="height: 90px;">
                                    <li>
                                    ...
                                    <ul>
                                        @foreach ($nomProjet as $npj)
                                            <div class="form-check">
                                                <li>
                                                    <input class="checkbox form-check-input" type="checkbox" name="Projet" value="{{ $npj->nom_projet}}"><span style="font-size: 12px">{{ $npj->nom_projet}}</span>
                                                </li>
                                            </div>
                                        @endforeach
                                    </ul>
                        ...
                        <th class="headProject" >
                            <div class="dropend" >
                                ...
                                <ul  class="dropdown-menu main p-2 overflow-scroll" style="height: 90px; overflow-y: auto; width: 100px !important">
                                    <li>
                                        <input type="text" class="column_search form-control form-control-sm">
                                    </li>
                                    <li>
                                    ...
                                    <ul>
                                        @foreach ($nomModules as $mdl)
                                            <div class="form-check">
                                                <li>
                                                    <input class="checkbox form-check-input" type="checkbox" name="session" value="{{ $mdl->nom_module}}"><span style="font-size: 12px">{{ $mdl->nom_module}}</span>
                                                </li>
                                            </div>
                                        @endforeach
                                    </ul>
                                ...
                                <ul  class="dropdown-menu main p-2 overflow-auto" style="height: 90px;">
                                    ...
                                    <ul>
                                        @foreach ($nomEntreprises as $etp)
                                            <div class="form-check">
                                                <li>
                                                    <input class="checkbox form-check-input" type="checkbox" name="session" value="{{ $etp->nom_etp}}"><span style="font-size: 12px">{{ $etp->nom_etp}}</span>
                                                </li>
                                            </div>
                                        @endforeach
                                    </ul>
                        ...
                        <th>
                            <div class="dropdown">
                                <a id="exampleE" tabindex="0" class="btn btn-sm btn-default" role="button" data-bs-toggle="popover" data-bs-placement="bottom" title="Recherche entre 2 périodes" style="width: 100%;">
                        ...
                        <th  >
                            <div class="dropend" >
                                ...
                                <ul class="dropdown-menu main p-2 overflow-auto" style="height: 100px;">
                                    <li>
                                        <input type="text" class="column_search form-control form-control-sm">
                                    </li>
                                    <li>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var example = document.getElementById('exampleE')
            var popover = new bootstrap.Popover(example, options)

            var proJR = $('#proJR');
            var endP = proJR.empty();
            $("#proJR").html('<div class="dropdown" id="proJ">\
                                    <button style="font-size: 13px" class="btn btn-default dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">\
                                        <i class="bx bx-library align-middle" style="color: #2e3950"></i> Projet\
                                    </button>\
                                    <ul class="dropdown-menu main p-2 overflow-auto" style="height: 220px;">\
                                        <li>\
                                            <input type="text" class="column_search form-control form-control-sm">\
                                        </li>\
                                        <li>\
                                        ...
                                        <ul>\
                                            <div class="form-check">\
                                                <li>\
                                                    <input class="checkbox form-check-input" type="checkbox" name="Projet" value=""><span style="font-size: 12px"></span>\
                                                </li>\
                                            </div>\
                                        </ul>\
                                    </ul>\
            ...
            $('.modifTable').on('keyup', ".column_search",function () {
                console.log($(this).val());
                table.column( $('#example').children().children().children().index()).search( this.value ).draw();
            } );
