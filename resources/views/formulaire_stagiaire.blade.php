                    ...
                    <div class="col-12">
                        <form action="{{route('remplir_information')}}" method="POST" class=" formulaire w-50" >
                            ...
                            <div class="mb-3 row text-end">
                                ...
                                <div class="col-sm-6">
                                    @if ($testNull[0]->nom_stagiaire != null)
                                        <input type="text" readonly class="form-control" id="nom_stg" name="nom_stg" value="{{$testNull[0]->nom_stagiaire}}">
                                    @else
                                        <input type="text" class="form-control" id="nom_stg" name="nom_stg" placeholder="nom" required>
                                    @endif
                                </div>
                            </div>
                            <div class="mb-3 row text-end">
                                ...
                                <div class="col-sm-9">
                                    @if ($testNull[0]->prenom_stagiaire != null)
                                        <input type="text" readonly class="form-control" id="prenom_stg" name="prenom_stg" value="{{$testNull[0]->prenom_stagiaire}}">
                                    @else
                                        <input type="text" class="form-control" id="prenom_stg" name="prenom_stg" placeholder="prénom" required>
                                    @endif
                                </div>
                            </div>
                            <div class="mb-3 row text-end">
                                ...
                                <div class="col-sm-4">
                                    @if ($testNull[0]->date_naissance != null)
                                        <input type="text" readonly class="form-control" id="date_naissance_stg" name="date_naissance_stg" value="{{$testNull[0]->date_naissance}}">
                                    @else
                            ...
                            <div class="mb-3 row text-end">
                                ...
                                <div class="col-sm-4">
                                    @if ($testNull[0]->genre_stagiaire != null)
                                        <input type="text" readonly class="form-control" id="genre_stg" name="genre_stg" value="{{$testNull[0]->genre_stagiaire}}">
                                    @else
                                        <select name="genre_stg" class="form-select test" id="genre_stg">
                            ...
                            <div class="mb-3 row text-end">
                                ...
                                <div class="col-sm-6">
                                    @if ($testNull[0]->mail_stagiaire != null)
                                        <input type="text" readonly class="form-control" id="email_stg" name="email_stg" value="{{$testNull[0]->mail_stagiaire}}">
                                    @else
                            ...
                            <div class="mb-3 row text-end">
                                ...
                                <div class="col-sm-4">
                                    @if ($testNull[0]->telephone_stagiaire != null)
                                        <input type="text" readonly class="form-control" id="tel_stg" name="tel_stg" value="{{$testNull[0]->telephone_stagiaire}}">
                                    @else
                            ...
                            <div class="mb-3 row text-end">
                                ...
                                <div class="col-sm-4">
                                    @if ($testNull[0]->cin != null)
                                        <input type="text" readonly class="form-control" id="cin_stg" name="cin_stg" value="{{$testNull[0]->cin}}">
                                    @else
                            ...
                            <div class="mb-3 row text-end">
                                ...
                                <div class="col-sm-9">
                                    @if ($testNull[0]->lot!=null and $testNull[0]->quartier!=null and $testNull[0]->ville!=null and $testNull[0]->code_postal!=null and $testNull[0]->region!=null )
                                        <input type="text" readonly class="form-control" id="" name="" value="{{$testNull[0]->lot}}&nbsp;{{$testNull[0]->quartier}}&sbquo;&nbsp;{{$testNull[0]->ville}}&nbsp;{{$testNull[0]->code_postal}}&sbquo;&nbsp;{{$testNull[0]->region}}">
                                    @else
                                        <div class="col-sm-5">
                                            ...
                                            @else
                                                <input type="text" class="form-control mb-3" id="ville" name="ville" placeholder="ville " required>
                                            @endif
                                            @if ($testNull[0]->code_postal != null)
                                                <input type="text" readonly class="form-control mb-3" id="code_postal" name="code_postal" value="{{$testNull[0]->code_postal}}">
                                            @else
                                                <input type="text" class="form-control mb-3" id="code_postal" name="code_postal" placeholder="code postal " required>
                                            @endif
                                            @if ($testNull[0]->region != null)
                                                <input type="text" readonly class="form-control mb-3" id="region" name="region" value="{{$testNull[0]->region}}">
                                            @else
                                                <input type="text" class="form-control mb-3" id="region" name="region" placeholder="region " required>
                                            @endif
                                        </div>
                                    @endif
                                </div>
                            ...
                            <div class="mb-3 row text-end">
                                ...
                                <div class="col-sm-8">
                                    @if ($testNull[0]->fonction_stagiaire != null)
                                        <input type="text" readonly class="form-control" id="fonction_stagiaire" name="fonction_stagiaire" value="{{$testNull[0]->fonction_stagiaire}}">
                                    @else
                                        <input type="text"  class="form-control" id="fonction_stagiaire" name="fonction_stagiaire" value="{{$testNull[0]->fonction_stagiaire}}" required>
                                    @endif
                                </div>
                            </div>
                            <div class="mb-3 row">
