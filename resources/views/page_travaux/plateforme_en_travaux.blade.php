...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <img src="{{asset('img_create-compte/ban_info_travaux.jpeg')}}" class="fit-image">
            <div class="d-grid gap-2 col-6 mx-auto mb-5">
                <a href="#"><button class="btn btn-success" style="align: center">En Cour de travaux merci</button></a>
            </div>
        </div>
    </div>
</div>
