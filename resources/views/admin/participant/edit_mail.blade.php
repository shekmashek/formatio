...
<div class="col-lg-4">
    <div class="p-3 form-control">
        ...
        <form   class="btn-submit" action="{{route('update_mail_resp',$stagiaire->id)}}" method="post" enctype="multipart/form-data" >
            @csrf
                ...
                <div class="image-upload">
                  ...
                  {{-- </div>
                     ...
                     <input id="file-input" type="file" name="image" value="{{$stagiaire->photos}}"/>
                        ...
                        <input type="email" class="form-control test input"  name="mail_resp" value="{{ $stagiaire->mail_stagiaire }}" >
