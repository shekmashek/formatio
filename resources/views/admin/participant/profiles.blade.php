                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="form-control">
                                    ...
                                    <img src="/stagiaire-image/{{$stagiaire->photos}}"  class="image-ronde">
                                </a>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="form-control">
                                    ...
                                    <div style="border-bottom: solid 1px #d399c2;" class="hover">
                                        <a href="#" >
                                    <p class="p-1 m-0" style="font-size: 10px;">BRANCHE<span style="float: right;">{{$branche->nom_branche}}&nbsp;<i class="fas fa-angle-right"></i></span>
                                    </p>
                                        </a>
                                    </div>
