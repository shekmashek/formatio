...
@section('title')
    <h3 class="text-white ms-5">Modification niveau</h3>
@endsection
@section('content')
<style>
   .input{
...
<div class="col-lg-4">
    <div class="p-3 form-control">
        <p style="text-align: left">Niveau d'etude</p>
  ...
  {{-- <p style="font-size: 20px;" class="ms-5">Profiles</p>
            <center>
                <div class="image-upload">
                  ...
                  <label class="ml-3 form-control-placeholder" style="font-size:13px;color:#801D68">Niveau d'etude</label>
