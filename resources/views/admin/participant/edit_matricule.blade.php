...
@section('title')
    <h3 class="text-white ms-5">Modification matricule</h3>
@endsection
@section('content')
<style>
     .input{
...
<div class="col-lg-4">
    <div class="p-3 form-control">
        <p style="text-align: left">Matricule</p>
            ...
            <center>
                <div class="image-upload">
                  ...
                  <div class="row px-3 mt-4">
                    ...
                    <input type="text" value="   {{ $stagiaire->matricule}}"  class="form-control test input"  name="matricule" placeholder="Matricule" >
                    <label class="ml-3 form-control-placeholder" style="font-size:13px;color:#801D68">Matricule</label>
