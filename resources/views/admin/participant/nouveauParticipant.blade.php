                    ...
                    <div class="container-fluid">
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                <li class="nav-item">
                                    <a class="nav-link  {{ Route::currentRouteNamed('liste_participant') ? 'active' : '' }}"
                                        aria-current="page" href="{{ route('liste_participant') }}">
                                        <i class="fa fa-list">Liste des stagiaires</i></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ Route::currentRouteNamed('nouveau_participant') ? 'active' : '' }}"
                                        aria-current="page" href="{{ route('nouveau_participant') }}">
                                ...
                                @can('isReferent')
                                    <div class="form-group">
                                        ...
                                        <select name="liste_dep" class="form-control" id="liste_dep">
                                            <option value="">Choisissez un département...</option>
                                            @foreach ($liste_dep as $liste)
                                                <option value="{{ $liste->departement->id }}">
                                                    {{ $liste->departement->nom_departement }}</option>
                                            @endforeach
                                        </select>
                                    </div><br>
                                @endcan
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    for (var $i = 0; $i < userData.length; $i++) {
                        $("#liste_dep").append('<option value="' + userData[$i].id + '">' + userData[$i]
