                ...
                <tbody>
                    @foreach ($salles as $salle)
                        <tr>
                            ...
                            <td><a href="{{ route('supprimer_salle_etp',[$salle->id]) }}"><i class="bx bx-trash"></i></a></td>
                        </tr>
                        <div class="modal fade"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content p-3">
                                    ...
                                    <form action="{{ route('modifier_salle_etp',[$salle->id]) }}" method="POST">
                                        @csrf
            ...
            <div class="container mt-1">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        @endif
                        <form action="{{ route('enregistrer_salle_etp') }}" method="POST">
                            @csrf
