                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <div id="info_cfp" class="collapse">
                                                            ...
                                                            <p>E-mail: <strong
                                                                    style="color: blue">{{ $projet->mail_cfp }}</strong> </p>
                                                        </div>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="card p-3 cardPayement">
                                                                    <form
                                                                        action="{{ route('update_groupe', $grp->groupe_id) }}"
                                            ...
                                            <div class="card p-3 cardPayement">
                                                <form action="{{ route('groupe.store') }}" id="formPayement"
                                                    ...
                                                    <div class="row mt-0 mb-0 pt-0 pb-0">
                                                        <div class="col">
                                                            <span>Date début</span>
                                                            <div class="inputbox inputboxP p-0 mt-0"> <input autocomplete="off"
                                                            ...
                                                            <div class="row m-0 p-0">
                                                                <div class="col">
                                                                    ...
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" name="entreprise[]" type="checkbox" id="inlineCheckbox1" value="{{ $etp->entreprise_id }}" required>
                                                                        <label class="form-check-label me-2" for="inlineCheckbox1">{{ $etp->nom_etp }}</label>
                                                                      </div>
                                                                    @endforeach
                                                                </div>
                                                            </div>
