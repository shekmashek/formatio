...
@section('title')
<h3 class="text_header m-0 mt-1">Modification compétence</h3>
@endsection
@section('content')
    ...
    <div class="col-lg-4">
        <div class="p-3 form-control">
            ...
            <form class="btn-submit" action="{{route('update_domaine',$formateur->id)}}" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" class="form-control test" name="domaine" value="  {{ $formateur->domaine }}">
                <div class="row px-3 mt-4">
                    <div class="form-group mt-1 mb-1">
                        <input type="text" class="form-control test input" name="competence" value="  {{ $formateur->competence }}">

                        <label class="ml-3 form-control-placeholder">Competence</label>
