...
@section('title')
<h3 class="text_header m-0 mt-1">Modification du fonction</h3>
@endsection
@section('content')
            ...
            <form class="btn-submit" action="{{route('update_experience',$formateur->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row px-3 mt-4">
                    <div class="form-group mt-1 mb-1">
                        <input type="text" class="form-control test input" name="tache" value="{{ $formateur->taches }}   ">
                ...
                <input type="hidden" class="form-control test input" name="nom_etp" value="  {{ $formateur->nom_entreprise }} ">
