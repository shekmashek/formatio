    ...
    <div class="col-md-3 ">
        <div class="row  my-5">
            ...
            <div id="nom"style="border-bottom: solid 1px #e8dfe5;">
                ...
                <p class="p-1 m-0" style="font-size: 12px;"><i class='bx bx-key' style='' ></i>&nbsp; A PROPOS DE MOI:<span style="float: right;">{{substr($formateur->description, 0, 20)."..."}}&nbsp;<i class="fas fa-angle-right"></i></span>
                </p>
                </a>
                </div>
