...
<div class="col-lg-4">
    <div class="p-3 form-control">
        ...
        <form   class="btn-submit" action="{{route('update_photo_formateur',$formateur->id)}}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="image-upload">
                  <label for="file-input">
                    <div class="upload-icon profilepic">
                        <img src="/formateur-image/{{$formateur->photos}}" id = "photo_stg"  class="image-ronde profilepic__image"> 
