            ...
            <form class="btn-submit" action="{{route('update_fin_travail',$entreprise->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row px-3 mt-4">
                    <div class="form-group mt-1 mb-1">
                        <input type="date" class="form-control test input" name="fin" value="{{ $entreprise->fin_travail }}" required>
                        <label class="ml-3 form-control-placeholder">Date de fin de travail</label>
                    </div>
                </div>
