    ...
    <div class="col-lg-4">
        ...
        <div class="row px-3 mt-4">
            <div class="form-group mt-1 mb-1">
                <input type="date" class="form-control test input" name="dateNais" value="{{ $formateur->date_naissance }}" required>
                <label class="form-control-placeholder">Anniversaire</label>
