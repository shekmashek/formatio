  ...
  @endif
    <div class="col-lg-4">
        <div class="p-3 form-control">
            ...
            <form class="btn-submit" action="{{route('update_specialite_prof',$formateur->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row px-3 mt-4">
                    <div class="form-group mt-1 mb-1">
                        <input type="text" value="{{ $formateur->specialite}}" class="form-control  input" name="specialite" required>
                        <label class="form-control-placeholder">Spécialité</label>
                    </div>
                </div>
