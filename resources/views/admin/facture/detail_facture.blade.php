                            ...
                            <table class="table ">
                                ...
                                <tbody class="mb-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$montant_facture->nom_projet." de la ".$montant_facture->nom_groupe.",avec nbre participant ".$montant_facture->nbre_participant." du ".$montant_facture->date_debut_session}}</td>
