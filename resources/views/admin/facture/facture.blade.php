                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Entreprise &nbsp; <button class="btn btn_creer_trie" data-val="0"><i class="fa fa-arrow-down"></i></button> </a> {{-- &nbsp;&nbsp;<a href="#" style="color: rgb(25, 25, 30);"><button class="btn btn_creer_trie"><i class="fa fa-arrow-up"></i></a></button> --}}

                                    </th>
                                    <th scope="col">Date de facturation</th>
                                    <th scope="col">Date de règlement &nbsp; <button class="btn btn_creer_trie" data-val="0"><i class="fa fa-arrow-down"></i></button> </a> {{-- &nbsp;&nbsp;<a href="#" style="color: rgb(25, 25, 30);"><button class="btn btn_creer_trie"><i class="fa fa-arrow-up"></i></a></button> --}}

                                    </th>
                                    <th scope="col">Total à payer &nbsp; <button class="btn btn_creer_trie" data-val="0"><i class="fa fa-arrow-down"></i></button> </a> {{-- &nbsp;&nbsp;<a href="#" style="color: rgb(25, 25, 30);"><button class="btn btn_creer_trie"><i class="fa fa-arrow-up"></i></a></button> --}}

                                    </th>
                                    <th scope="col">Solde &nbsp; <button class="btn btn_creer_trie" data-val="0"><i class="fa fa-arrow-down"></i></button> </a> {{-- &nbsp;&nbsp;<a href="#" style="color: rgb(25, 25, 30);"><button class="btn btn_creer_trie"><i class="fa fa-arrow-up"></i></a></button> --}}
                        ...
                        , success: function(response) {
                            ...
                            if (facture_payer.length > 0) {
                                ...
                                for (var i_payer = 0; i_payer < facture_payer.length; i_payer += 1) {
                                    ...
                                    if (facture_payer[i_payer].facture_encour == "valider") {

                                        html_payer += ' <div class="dropdown"><div class="btn-group dropstart"> <button type="button" class="btn  btn_creer_trie dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> </button> ';
                                        html_payer += '  <ul class="dropdown-menu">';
                                        html_payer += '  <a href="#" class="dropdown-item">';
                                        html_payer += ' <button type="button" class=" btn  payement" data-id="' + facture_payer[i_payer].num_facture + '" id="' + facture_payer[i_payer].num_facture + '" data-bs-toggle="modal" data-bs-target="#modal">Faire un encaissement</button>';
                                        html_payer += '</a>';
                                    ...
                                    } else if (facture_payer[i_payer].facture_encour == "en_cour") {
