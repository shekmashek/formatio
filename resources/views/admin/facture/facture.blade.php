                                ...
                                <td>
                                    <div class="dropdown">
                                        <div class="btn-group dropstart">
                                            ...
                                            <ul class="dropdown-menu">
                                                {{-- <a href="#">
                                                    <button type="button" class="btn btn-primary payement" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                    ...
                    <form action="{{ route('encaisser') }}" id="formPayement" method="POST">
                        ...
                        <div class="inputbox inputboxP mt-3">
                            <span>Description</span>
                             <input autocomplete="off" type="text" name="libelle" class="form-control formPayement" required="required">
                            </div>
                        <div class="inputbox inputboxP mt-3">
...
{{-- debut modal encaissement --}}
{{-- <div id="modal" class="modal fade" data-backdrop="true"> --}}
{{-- <div id="modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-title text-md">
