                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <div class="modal-title text-md">
                                                    <h6>N° facture : <span class="text-mued" id="num_fact_encaissement">{{ $actif->num_facture }}</span></h6>
                                            ...
                                            <div class="inputbox inputboxP mt-3 ms-1">
                                                <span>Description</span>
                                                <textarea autocomplete="off" name="libelle" class="text_description form-control" placeholder="description d'encaissement"></textarea>

                                            </div>
                                            <div class="inputbox inputboxP mt-3  ms-1">
                                                <span>Montant à facturer</span>
                                                <input autocomplete="off" type="number" min="1" name="montant" class="form-control formPayement" required="required"> </div>
                                            ...
                                            <div class="inputbox inputboxP mt-3  ms-1">
                                                ...
                                                <input type="date" name="date_encaissement" class="form-control formPayement" required="required">
                                            </div>
            ...
            function getDataFactureValider(facture_actif) {
                ...
                if (facture_actif.length > 0) {
                    ...
                    for (var i_actif = 0; i_actif < facture_actif.length; i_actif += 1) {
                        ...
                        html_actif += '<h6>N° facture : <span class="text-mued" id="num_fact_encaissement">' + facture_actif[i_actif].num_facture + '</span></h6>';

                        html_actif += '<h5>Reste à payer : <strong><label id="montant"></label> Ar ' + dernier_montant_ouvert + '</strong></h5>';
                        html_actif += '</div>';
                        html_actif += '</div>';
                        ...
                        html_actif += ' <textarea autocomplete="off" name="libelle" id="libelle" class="text_description form-control" placeholder="description"></textarea>';

                        html_actif += '</div>';
                        html_actif += ' <div class="inputbox inputboxP mt-3  ms-1">';
                        html_actif += ' <span>Montant à facturer</span>';
                        html_actif += ' <input autocomplete="off" type="number" min="1" pattern="[0-9]" name="montant" class="form-control formPayement" required="required"> </div>';

                        html_actif += ' <div class="form-group  mt-3  ms-1">';
                        html_actif += '   <span>Mode de paiement<strong style="color:#ff0000;">*</strong></span>';
                        html_actif += '  <select class="form-select selectP" name="mode_payement" id="mode_payement" aria-label="Default select example">';
                        ...
                        html_actif += '<input type="date" name="date_encaissement" id="date_encaissement" class="form-control formPayement" required="required">';
                        html_actif += ' </div>';
