                        ...
                        <div class="col-6 p-4">
                            <div class="row mb-2">
                                <div class="col-12 d-flex flex-row justify-content-end">
                                    <p class="m-0 pt-3 text-end me-3">N° facture</p> <input type="text" value="{{$montant_totale->num_facture}}" class="text-end titre_facture form-select  mb-2 m-0 " name="num_facture" required placeholder="reference du facture">
                                    @error('num_facture')
                            ...
                            <div class="row mb-2">
                                <div class="col-12 d-flex flex-row justify-content-end">
                                    <p class="m-0 pt-3 text-end me-3">N° BC</p> <input type="text" value="{{$session[0]->reference_bc}}" class="text-end titre_facture form-select  mb-2 m-0 " name="reference_bc" id="reference_bc" required placeholder="reference du bon de commande">
                                    @error('reference_bc')
                                    <p> <span style="color:#ff0000;"> {{$message}} </span></p>
                                    @enderror
                            ...
                            <div class="row mb-2">
                                <div class="col-12 d-flex flex-row justify-content-end">
                                    <p class="m-0 pt-3 text-end me-3">Date de facturation</p> <input type="date" value="{{$montant_totale->invoice_date}}" class="text-end titre_facture form-select  mb-2 m-0 " name="invoice_date" id="invoice_date" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 d-flex flex-row justify-content-end">
                                    <p class="m-0 pt-3 text-end me-3">Date de règlement</p> <input type="date" value="{{$montant_totale->due_date}}" class="text-end titre_facture form-select  mb-2 m-0 " name="due_date" id="due_date" required>
                                </div>
                            </div>
                        </div>
                    </div>
