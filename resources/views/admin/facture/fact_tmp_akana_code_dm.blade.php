                                ...
                                <div class="filtrer mt-3">
                                    <div class="row">
                                        ...
                                        <div class="row mt-0 navigation_module">
                                            <p>
                                                <a data-bs-toggle="collapse" href="#detail_par_thematique" role="button" aria-expanded="false" aria-controls="detail_par_thematique" class="dte_filtre">Recherche par intervale de date de facturation <i class="fa icon_filtre fa-arrow-down"></i></a>
                                            </p>
                                            ...
                                            <hr>
                                            <p>
                                                <a data-bs-toggle="collapse" class="num_fact_filtre" href="#search_num_fact" role="button" aria-expanded="false" aria-controls="search_num_fact">Recherche par numero de facture <i class="fa icon_filtre fa-arrow-down"></i></a>
                                            </p>
                                            ...
                                            <hr>
                                            <p>
                                                <a data-bs-toggle="collapse" href="#detail_par_solde" role="button" aria-expanded="false" class="solde_filtre" aria-controls="detail_par_solde">Recherche par intervale de solde <i class="fa icon_filtre fa-arrow-down"></i></a>
                                            </p>
                                            ...
                                            <hr>
                                            <p>
                                                <a data-bs-toggle="collapse" href="#detail_par_etp" role="button" aria-expanded="false" class="entiter" aria-controls="detail_par_etp">Recherche par Entreprise <i class="fa icon_filtre fa-arrow-down"></i></a>
                                            </p>
