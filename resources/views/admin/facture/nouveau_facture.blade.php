                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item btn_next">
                                    <a class="nav-link  {{ Route::currentRouteNamed('liste_facture',2) || Route::currentRouteNamed('liste_facture',2) ? 'active' : '' }}"
                                        href="{{route('liste_facture',2)}}">Liste des Factures</a>
                                </li>
                                @canany(['isSuperAdmin','isCFP'])
                                <li class="nav-item btn_next">
                                    <a class="nav-link  {{ Route::currentRouteNamed('facture') ? 'active' : '' }}"
                                        href="{{route('facture')}}">Nouveau Facture</a>
                                </li>
                                @endcanany
                            </ul>
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form action="{{route('create_facture')}}" id="msform_facture" method="POST"
                    ...
                    <div id="formulaire">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <select class="form-select selectP input" id="entreprise_id"
                                                name="entreprise_id" aria-label="Default select example">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <select class="form-select selectP input" id="projet_id" name="projet_id"
                        ...
                        <fieldset class="shadow p-3 mb-5 bg-body rounded">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <input type="text" required class="form-control input reference_bc"
                                            id="reference_bc" name="reference_bc">
                                ...
                                <div class="col">
                                    {{-- <div class="form-group"> --}}
                                        <label align="left" for="down_bc" class="form-label">
                                            Upload Bon de Commande(Format pdf :maximum 1.5M.0)<strong
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required class="form-control input"
                                            id="exampleFormControlInput1" name="invoice_date"
                                            id="invoice_date" onfocus="(this.type='date')">
                                            <label for="invoice_date" class="form-control-placeholder">Date création Facture<strong
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required class="form-control input"
                                            name="due_date" id="due_date" onfocus="(this.type='date')">
                                            <label for="due_date" class="form-control-placeholder">Durer de Date<strong
                                                style="color:#ff0000;">*</strong></label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <fieldset class="shadow p-3 mb-5 bg-body rounded">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <select class="form-select input" aria-label="Default select"
                                            name="type_facture" id="type_facture">
                                            @foreach ($type_facture as $tp)
                                            <option value="{{$tp->id}}">{{$tp->description}}</option>
                                            @endforeach
                                        </select>
                                        <label for="exampleFormControlInput1" class="form-control-placeholder">Type Facture<strong
                                            style="color:#ff0000;">*</strong></label>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select input"
                                            aria-label=".form-select-lg example" name="id_mode_financement">
                            ...
                            <div class="row">
                                <div class='col'>
                                    <div class="form-group">
                                        ...
                                        <select class="form-select input" aria-label="Default select example" name="tax_id"
                                            id="tax_id">
                                            @foreach ($taxe as $t)
                                            <option value="{{$t->id}}">{{$t->description}}</option>
                                            @endforeach
                                        </select>
                                        <label for="exampleFormControlInput1" class="form-control-placeholder">Tax<strong
                                            style="color:#ff0000;">*</strong></label>
                                    </div>
                                </div>
                                <div class='col'>

                                    <select class="form-select form-select-md input" aria-label="form-select-lg example"
                                        name="id_type_payement">
                        ...
                        <fieldset class="shadow p-3 mb-5 bg-body rounded">
                            ...
                            {{-- <div style="background-color: rgb(214, 218, 214);"> --}}
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <button id="addRowMontant" type="button" class="btn btn_next">Montant</button>
                                    </div>
                                    <div class="col-md-7">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-auto">
                                    <button id="addRow" type="button" class="btn btn_next">Frais Annexe</button>
                                </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="number" min="0" value="0" placeholder="remise(facultatif)"
                                            class="form-control input" name="remise" id="remise">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <textarea class="form-control text_area pt-2" placeholder="'votre commentaire ou description'"
                                            id="other_message" name="other_message" style="height: 80px !important;"></textarea>
                        ...
                        <fieldset class="shadow p-3 mb-5 bg-body rounded">
                            {{-- <div class="form-card"> --}}
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-3">
                                        <div class="form-group">
                                            <img src="{{asset('img_create-compte/terminer.png')}}" class="fit-image"
