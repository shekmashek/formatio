                ...
                <section class="section3">
                    <div class="row entreprise_facturer">
                        ...
                        <div class="col-6 p-4">
                            ...
                            <div class="row mb-2">
                                <div class="col-12 d-flex flex-row justify-content-end">
                                    <p class="m-0 pt-3 text-end me-3">N° BC</p> <input type="text" autocomplete="off" class="form-control input_simple reference_bc" name="reference_bc" id="reference_bc" required placeholder="reference du bon de commande">
                                    @error('reference_bc')
                                    <p> <span style="color:#ff0000;"> {{$message}} </span></p>
                                    @enderror
                                </div>
        ...
        if ($total_session_possible < ($("#addRowMontant").val())) {
            ...
            $.ajax({
                ...
                , success: function(response) {
                    ...
                    html += '</div>';
                    html += '<div class="col-3">';
                    html += '<input type="text" name="description[]" id="description[]" placeholder=" ex: personne ou groupe ou etc" class="form-control qte input_quantite" required>';
                    html += '</div>';
                    html += '<div class="col-2">';
