...
<div class="col-lg-4">
    <div class="p-3 form-control">
        ...
        <form   class="btn-submit" action="{{route('update_email_manager',$chef->id)}}" method="post" enctype="multipart/form-data">
            @csrf

                        <div class="row px-3 mt-4">
                            <div class="form-group mt-1 mb-1">
                                <input type="text" class="form-control input test"  name="mail_chef" value="{{ $chef->mail_chef}}" >

                        <label class="ml-3 form-control-placeholder">Email</label>  
                        </div>
                    </div>
                    <select  hidden  value="{{$chef->genre_chef}}" name="genre" class="form-select test input" id="genre"  >
                      ...
                      <input type="hidden" value="{{ $chef->cin_chef}}" class="form-control input test"  name="cin_chef" >
                    ...
                    {{-- <label class="ml-3 form-control-placeholder" style="font-size:13px;color:#801D68">Nom</label> --}}
                        ...
                        <input type="hidden" class="form-control test" name="genre_chef" value="{{ $chef->genre_chef}}">
