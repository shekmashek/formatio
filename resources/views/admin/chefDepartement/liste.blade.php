                                ...
                                <table class="table table-striped table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        @for($i = 0; $i < count($referent); $i++) <tr class="text-center content_table">
                                            ...
                                            <td>
                                                <div align="left">
                                                    @for($j = 0; $j < count($roles_not_actif_referent); $j++)
                            ...
                            <table class="table table-striped" id="dataTables-example">
                                ...
                                <tbody>
                                    @for($i = 0; $i < count($stagiaires); $i++) <tr class="text-center content_table">
                                        ...
                                        <td>
                                            <div align="left">
                                                @for($j = 0; $j < count($roles_not_actif_stg); $j++) @if($stagiaires[$i]->user_id == $roles_not_actif_stg[$j]["user_id"])
                                                    <span style="color:blueviolet">attribué role pour {{$roles_not_actif_stg[$j]["role_name"]}}
                                                        <button class="btn modifier pt-0"><a href="{{route('add_role_user',[$stagiaires[$i]->user_id,$roles_not_actif_stg[$j]["id"]])}}"><i class='bx bx-edit background_grey' style="color: #0052D4 !important;font-size: 15px" title="modifier les informations"></i></a></button>
                                                    </span> <br>
                                                    @endif
                                                    @endfor
                                            </div>
                                    ...
                                    <tr class="text-center content_table">
                                        ...
                                        <td>
                                            <div align="left">
                                                ...
                                                @if($chefs->user_id == $role_asigner_manager->user_id)
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('role_manager')}}" method="POST">
                                                        ...
                                                        {{-- @php
                                                                $a = 0;
                                                            @endphp --}}
                                                        @for($a = 0;$a < count($user_role);$a++) @if($chefs->user_id == $user_role[$a]->user_id)
                                                            @php
