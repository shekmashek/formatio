                                    ...
                                    @for($i = 0; $i < count($referent); $i++) <tr class="text-center content_table">
                                        ...
                                        <td>
                                            <div align="left">
                                                ...
                                                <span><i class="fa fa-check" style="color: green" aria-hidden="true"></i>
                                        ...
                                        <td>
                                            <div align="left">
                                                @for($ii = 0; $ii < count($roles_not_actif_referent[$i]["role_inactif"]); $ii++) @if($referent[$i]->user_id ==
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped" id="dataTables-example">
                            ...
                            <tbody id="dynamic_row">
                                @for($i = 0; $i < count($stagiaires); $i++) <tr class="text-center content_table empNew" data-id={{$stagiaires[$i]->user_id}} id={{$stagiaires[$i]->user_id}} onclick="afficherInfos();">
                                    <td>
                                        @if($stagiaires[$i]->photos == null)
                                        <center>
                                            <p class="randomColor text-center" style="color:white; font-size: 15px; border: none; border-radius: 100%; height:50px; width:50px ;">
                                                <span class="" style="position:relative; top: .9rem;"><b>{{$stagiaires[$i]->nom}}{{$stagiaires[$i]->prenom}}</b></span>
                                            </p>
                                        </center>
                                        @else
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped" id="dataTables-example">
                            ...
                            <tbody id="dynamic_rowC">
                                ...
                                @else
                                <a href="{{asset('images/chefDepartement/'.$chef[$i]->photos)}}"> <img title="clicker pour voir l'image" src="{{asset('images/chefDepartement/'.$chef[$i]->photos)}}" style="width:50px; height:50px; border-radius:100%; font-size:15px"></a>
                                </td>
                                @endif
                                <td>
                                    {{$chef[$i]->nom_chef}}
