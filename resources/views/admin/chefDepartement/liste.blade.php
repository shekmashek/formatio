            ...
            <div class="col-lg-12 mt-2">
                <div class="panel panel-default">
                    ...
                    <div class="row">
                        <div class="col-md-8 mb-3">
                            <ul class="nav navbar-nav navbar-list me-auto mb-2 mb-lg-0 d-flex flex-row nav_bar_list">
                                <li class="nav-item ms-5">
                                    <a href="#" class="btn_next referentClass" id="employé" data-bs-toggle="tab"
                                        data-bs-target="#tab-employé" type="button" role="tab" aria-controls="tab-employé"
                                        aria-selected="false">
                                        Référents
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="#" class="btn_next chefClass" id="manager" data-bs-toggle="tab"
                                        data-bs-target="#tab-manager" type="button" role="tab" aria-controls="tab-manager"
                                        aria-selected="false">
                                        Chef de département
                                    </a>
                                </li>
                        ...
                        <div class="col-md">
                            <div class="">
                                <a href="#" class="btn_creer text-center filter mt-3" role="button"
                                    onclick="afficherFiltre();"><i class='bx bx-filter icon_creer'></i>Afficher les
                                    filtres</a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            @for ($i = 0; $i < count($referent); $i++)
                                                <tr class="text-center content_table">
                                                    <td>
                                                        ...
                                                        @else
                                                            <a
                                                                href="{{ asset('images/responsables/' . $referent[$i]->photos) }}"><img
                                    ...
                                    <table class="table table-striped" id="dataTables-example">
                                        ...
                                        <tbody id="dynamic_row">
                                            @for ($i = 0; $i < count($stagiaires); $i++)
                                                <tr class="text-center content_table empNew"
                                                    data-id={{ $stagiaires[$i]->user_id }}
                                                    id={{ $stagiaires[$i]->user_id }} onclick="afficherInfos();">
                                                    <td>
                                                        ...
                                                        @else
                                                            <a
                                                                href="{{ asset('images/stagiaires/' . $stagiaires[$i]->photos) }}"><img
                                                                    title="clicker pour voir l'image"
                                                            ...
                                                            @for ($ii = 0; $ii < count($roles_not_actif_stg[$i]['role_inactif']); $ii++)
                                                                @if ($stagiaires[$i]->user_id == $roles_not_actif_stg[$i]['user_id'])
                                                                    <span style="color:rgb(137, 43, 226)">
                                                                        ...
                                                                        <button class="btn modifier pt-0"><a
                                                                                href="{{ route('add_role_user', [$stagiaires[$i]->user_id, $roles_not_actif_stg[$i]['role_inactif'][$ii]->id]) }}">
                                                                                <i class='bx bx-edit background_grey'
                                                                                    style="color: #0052D4 !important;font-size: 15px"
                                                                                    title="modifier les informations"></i>
                                                                            </a></button>
                                                                    </span> <br>
                                                                @endif
                                                            @endfor
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <form action="/referents/filtre/query/fonction" method="post">
                                        @csrf
                                        <input style="width: 265px" type="text" name="fonctionReferent"
                                            id="fonctionReferent" class="mt-3 form-control form-control-sm mb-2"
                                            placeholder="Entrez une fonction ...">
                                    </form>
                                    <hr>
                                    <form action="/referents/filtre/query/name" method="post">
                                        @csrf
                                        <input style="width: 265px" type="text" name="nameReferent" id="nameReferent"
                                            class="mt-3 form-control form-control-sm mb-2" placeholder="Entrez un nom ...">
                                    </form>
                                    <form action="/referents/filtre/query/matricule" method="post">
                                        @csrf
                                        <input style="width: 265px" type="text" name="matriculeReferent"
                                            id="matriculeReferent" class="mt-3 form-control form-control-sm mb-2"
                                            placeholder="Entrez une matricule ...">
                                    </form>
                                    <form action="/referents/filtre/query/role" method="post">
                                        @csrf
                                        <input style="width: 265px" type="text" name="roleReferent" id="roleReferent"
                                            class="mt-3 form-control form-control-sm mb-2"
                            ...
                            <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <form action="/employes/filtre/query/fonction" method="post">
                                        @csrf
                                        <input style="width: 265px" type="text" name="test" id="test"
                                            class="mt-3 form-control form-control-sm mb-2"
                                            placeholder="Entrez une fonction ...">
                                    </form>
                                    <hr>
                                    <form action="/employes/filtre/query/name" method="post">
                                        @csrf
                                        <input style="width: 265px" type="text" name="name" id="name"
                                            class="mt-3 form-control form-control-sm mb-2" placeholder="Entrez un nom ...">
                                    </form>
                                    <form action="/employes/filtre/query/matricule" method="post">
                                        @csrf
                                        <input style="width: 265px" type="text" name="matricule" id="matricule"
                                            class="mt-3 form-control form-control-sm mb-2"
                                            placeholder="Entrez une matricule ...">
                                    </form>
                                    <form action="/employes/filtre/query/role" method="post">
                                        @csrf
                                        <input style="width: 265px" type="text" name="role_name" id="role_name"
                                            class="mt-3 form-control form-control-sm mb-2"
                                            placeholder="Entrez un rôle ...">
                                    </form>
                                </div>
                                ...
                                <div class="accordion-body">
                                    <form action="/chefs/filtre/query" method="post">
                                        ...
                                        <form action="/chefs/filtre/query/fonction" method="post">
                                            @csrf
                                            <input style="width: 265px" type="text" name="fonctionChef" id="fonctionChef"
                                                class="mt-3 form-control form-control-sm mb-2"
                                                placeholder="Entrez une fonction ...">
                                        </form>
                                    </form>
                                    ...
                                    <form action="/chefs/filtre/query/name" method="post">
                                        @csrf
                                        <input style="width: 265px" type="text" name="nameChef" id="nameChef"
                                            class="mt-3 form-control form-control-sm mb-2" placeholder="Entrez un nom ...">
                                    </form>
                                    <form action="/chefs/filtre/query/matricule" method="post">
                                        @csrf
                                        <input style="width: 265px" type="text" name="matriculeChef" id="matriculeChef"
                                            class="mt-3 form-control form-control-sm mb-2"
                                            placeholder="Entrez une matricule ...">
                                    </form>
                                    <form action="/chefs/filtre/query/role" method="post">
                                        @csrf
                                        <input style="width: 265px" type="text" name="roleChef" id="roleChef"
                                            class="mt-3 form-control form-control-sm mb-2"
                                            placeholder="Entrez un rôle ...">
                                    </form>
                                </div>
    ...
    <div class="infos mt-3">
        ...
        <script>
            $('.empNew').on('click', function() {
                ...
                $.ajax({
                    method: "GET",
                    url: "newAfficheInfo/employe/emp/" + user_id,
                    dataType: "html",
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $.each(res, function(index, value) {
                            ...
                            tableRow +=
                                '<td><img src="{{ asset('images/stagiaires/:?') }}" alt="" style="width:50px; height:50px; border-radius:100%">';
                            ...
                            tableRow +=
                                ...
                                '</td><td><i class="fa fa-check" style="color: green; margin-right: 5px"></i>' +
                                value.role_name +
                                '</td><tr>';
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $.each(res, function(index, value) {
                            ...
                            tableRow += '<tr class="text-center content_table">';
                            tableRow +=
                                '<td><img src="{{ asset('images/responsables/:?') }}" alt="" style="width:50px; height:50px; border-radius:100%">';
                            tableRow = tableRow.replace(":?", value.photos);
                            tableRow +=
                                '</td><td>' + value.matricule +
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $.each(res, function(index, value) {
                            ...
                            tableRow += '<tr class="text-center content_table">';
                            tableRow +=
                                '<td><img src="{{ asset('images/chefDepartement/:?') }}" alt="" style="width:50px; height:50px; border-radius:100%">';
                            tableRow = tableRow.replace(":?", value.photos);
                            tableRow +=
                                '</td><td>' + value.id +
