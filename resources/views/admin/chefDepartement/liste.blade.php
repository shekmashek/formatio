                                        ...
                                        @for($i = 0; $i < count($referent); $i++) <tr class="text-center content_table">
                                            ...
                                            <td>
                                                <div align="left">
                                                    ...
                                                    @if($stagiaires[$i]->user_id == $role_asigner_referent->user_id)

                                                    @if ($role_asigner_referent->role_id == 3)
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="userID_{{$stagiaires[$i]->id}}_roleID_{{$role_asigner_referent->role_id}}" checked disabled>
                                                        <label class="form-check-label" for="userId_{{$stagiaires[$i]->id}}_roleID_{{$role_asigner_referent->role_id}}"><i class="fa fa-check" style="color: green" aria-hidden="true"></i> {{$role_asigner_referent->role_name}}</label>
                                                    </div>
