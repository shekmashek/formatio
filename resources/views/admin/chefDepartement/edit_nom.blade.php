    ...
    <div class="p-3 form-control">
        ...
        <form   class="btn-submit" action="{{route('update_chef',$chef->id)}}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <input type="text" value="   {{ $chef->nom_chef }}" class="form-control test input"  name="nom_chef">
                    ...
                    <div class="row px-3 mt-4">
                        <div class="form-group mt-1 mb-1">
                        <input type="text" class="form-control test input" value="   {{ $chef->prenom_chef }}"  name="prenom_chef">
