...
<div class="container_code">
  {{-- <div class="form-control"> --}}
    <div class="text_center">
      <span style="text-transform: uppercase">RESULTATS EVALUATIONS A CHAUD, FORMATION {{ $session->nom_formation}}&nbsp; @php
      ...
      <div class="table-rating-bar justify-content-center">
        <table class="text-left mx-auto">
            <tr>
                ...
                <td class="text-right"><span class="rating-label">{{ round(($note_10_q8[0]->note+$note_10_q9[0]->note+$note_10_q10[0]->note)/3,1) }}</span>&nbsp;<span class="text-muted">80%</span>
                </td>
            </tr>
        </table>
      </div>
