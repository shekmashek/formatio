    ...
    <div class="row mt-2">
                             ...
                             <div class="col-lg-4">
                                 ...
                                 <div class="form-control">
                                     ...
                                     <a href="{{route('edit_photos',$ref->id)}} " >
                                        <img src="/responsable-image/{{$ref->photos}}" class="image-ronde">
                                    </a>
                                    </div>
                                    <div class="hover" style="border-bottom: solid 1px #d399c2;">
                                     <a href="{{route('edit_nom',$ref->id))}} " >
                                     <p class="p-1 m-0" style="font-size: 10px;">NOM<span style="float: right;">{{$ref->nom_resp}} {{$ref->prenom_resp}} &nbsp;<i class="fas fa-angle-right"></i></span>
                                         
                                     </p></a>
                                     
                                    </div>
                                    <div class="hover" style="border-bottom: solid 1px #d399c2;">
                                     <a href="{{route('edit_naissance',$ref->id)}} " >
                                     <p class="p-1 m-0" style="font-size: 10px;">ANNIVERSAIRE<span style="float: right;">{{date('j \\ F Y', strtotime($ref->date_naissance_resp))}}&nbsp;<i class="fas fa-angle-right"></i></span>
                                         
                                     </p></a>
                      
                                    </div>
                                    <div class="hover" style="border-bottom: solid 1px #d399c2;">
                                     <a href="{{route('edit_genre',$ref->id)}} " >
                                     <p class="p-1 m-0" style="font-size: 10px;">GENRE<span style="float: right;">{{$ref->sexe_resp}}&nbsp;<i class="fas fa-angle-right"></i></span>
                                     </p>
                                     </a>
                                    </div>
                                    <div class="hover" style="border-bottom: solid 1px #d399c2;">
                                 ...
                                 <div class="col-lg-4">
                                     ...
                                     <div class="form-control">
                                         ...
                                         <div style="border-bottom: solid 1px #d399c2;" class="hover">
                                             <a href="{{route('edit_mail',$ref->id)}} " >
                                         <p class="p-1 m-0" style="font-size: 10px;">ADRESSE E-MAIL<span style="float: right;">{{$ref->email_resp}}&nbsp;<i class="fas fa-angle-right"></i></span>
                                             
                                         </p>
                                             </a>
                                         </div>
                                         <div style="border-bottom: solid 1px #d399c2;" class="hover">
                                             <a href="{{route('edit_phone',$ref->id)}} " >
                                         <p class="p-1 m-0" style="font-size: 10px;">TELEPHONE<span style="float: right;">{{$ref->telephone_resp}}&nbsp;<i class="fas fa-angle-right"></i> </span>
                                         ...
                                         <div style="border-bottom: solid 1px #d399c2;" class="hover">
                                             <a href="{{route('edit_cin',$ref->id)}} " >
                                         <p class="p-1 m-0" style="font-size: 10px;">CIN<span style="float: right;">{{$ref->cin_resp}}&nbsp;<i class="fas fa-angle-right"></i></span>
                                         </p>
                                             </a>
                                         </div>                                                         
                                         <div style="border-bottom: solid 1px #d399c2;" class="hover">
                                      <a href="{{route('edit_adresse',$ref->id)}} " >
                                         <p class="p-1 m-0" style="font-size: 10px;">ADRESSE<span style="float: right;">{{$ref->adresse_lot}} &nbsp;{{$ref->adresse_quartier}} &nbsp;{{$ref->adresse_ville}} &nbsp;{{$ref->adresse_code_postal}}&nbsp;{{$ref->adresse_region}}&nbsp;<i class="fas fa-angle-right"></i></span>
                                             
                                         </p>
                                      </a>
                                         </div>
                                         <div style="border-bottom: solid 1px #d399c2;" class="hover">
                                             <a href="{{route('edit_fonction',$ref->id)}} " >
                                         <p class="p-1 m-0" style="font-size: 10px;">FONCTION<span style="float: right;">{{$ref->fonction_resp}}&nbsp;<i class="fas fa-angle-right"></i></span>
                                         </p>
                                             </a>
                                         </div>
