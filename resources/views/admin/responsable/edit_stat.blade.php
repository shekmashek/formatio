...
<div class="col-lg-4">
    <div class="p-3 form-control">
        <p style="text-align: left">Stat</p>
        <form   class="btn-submit" action="{{route('update_entreprise',$responsable->id)}}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <input type="text" class="form-control input test"  name="stat"  value="  {{ optional(optional($responsable)->entreprise)->stat}}" >
                    <label class="ml-3 form-control-placeholder" style="font-size:13px;color:#801D68">Stat</label>
