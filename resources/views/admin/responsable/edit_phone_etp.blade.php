...
<div class="col-lg-4">
    <div class="p-3 form-control">
        <p style="text-align: left">Téléphone entreprise</p>
            ...
            @csrf
                  ...
                  <input type="hidden" class="form-control test input" value="   {{ $responsable->prenom_resp }}"  name="prenom">
                    ...
                    <div class="row px-3 mt-4">
                        ...
                        <input type="text" class="form-control input test"  name="phone_etp"  value="  {{ optional(optional($responsable)->entreprise)->telephone_etp}}" >
