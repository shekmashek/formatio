    ...
    <div class="p-3 form-control">
        ...
        <form   class="btn-submit" action="{{route('update_entreprise',$responsable->id)}}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <input type="hidden" class="form-control input test"  name="adresse"  value="  {{ optional(optional($responsable)->entreprise)->adresse}}" >
                    ...
                    <label class="ml-3 form-control-placeholder" >CIF</label>
