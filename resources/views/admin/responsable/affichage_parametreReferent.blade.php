        ...
        <div class="col-5 info_plus4 p-5 pt-4">
            ...
            <div class="row border_bas">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bxl-gmail icon_sociaux1'></i>&nbsp;{{$entreprise->email_etp}}</p><p class="text-end"><a href="{{route('modification_email_entreprise',$entreprise->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row border_bas mt-3">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bx-calculator icon_sociaux1'></i>&nbsp;{{$entreprise->telephone_etp}}</p><p class="text-end"><a href="{{route('modification_telephone_entreprise',$entreprise->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row border_bas mt-3">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bx-intersect icon_sociaux1'></i>&nbsp;{{$secteur[0]->nom_secteur}}</p><p class="text-end"><a href="{{route('modification_secteur_entreprise',$entreprise->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row mt-3">
        ...
        <div class="col-4 info_plus2 p-5 pt-4">
            ...
            <div class="row border_bas">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bxs-map icon_sociaux2'></i>&nbsp;{{$entreprise->adresse_rue}}&nbsp;{{$entreprise->adresse_quartier}}</p><p class="text-end"><a href="{{route('modification_adresse_entreprise',$entreprise->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row border_bas mt-3">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bxs-map-pin icon_sociaux2'></i>&nbsp;{{$entreprise->adresse_ville}}&nbsp;{{$entreprise->adresse_code_postal}}</p><p class="text-end"><a href="{{route('modification_adresse_entreprise',$entreprise->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row border_bas mt-3">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bx-map-alt icon_sociaux2'></i>&nbsp;{{$entreprise->adresse_region}}</p><p class="text-end"><a href="{{route('modification_adresse_entreprise',$entreprise->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row mt-3">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bx-globe icon_sociaux2'></i>&nbsp;{{$entreprise->site_etp}}</p><p class="text-end"><a href="{{route('modification_site_etp_entreprise',$entreprise->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row mt-3">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bx-sitemap icon_sociaux3'></i>NIF :&nbsp;{{$entreprise->nif}}</p><p class="text-end"><a href="{{route('modification_nif_entreprise',$entreprise->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row mt-3">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bx-align-justify icon_sociaux3'></i>STAT :&nbsp;{{$entreprise->stat}}</p><p class="text-end"><a href="{{route('modification_stat_entreprise',$entreprise->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row mt-3">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bxs-check-shield icon_sociaux3'></i>RCS :&nbsp;{{$entreprise->rcs}}</p><p class="text-end"><a href="{{route('modification_rcs_entreprise',$entreprise->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row mt-3">
                <div class="col">
                    ...
                    @else
                        <div class="p-1 m-0 justify-content-between d-flex flex-row afficher_icon_modif"><p><i class='bx bx-check-shield icon_sociaux3'></i>CIF :&nbsp;{{$entreprise->cif}}</p><p class="text-end"><a href="{{route('modification_cif_entreprise',$entreprise->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
        </div>
            ...
            <div class="row border_bas">
                <div class="col text-center afficher_icon_modif">
                    ...
                    @elseif($entreprise->assujetti_id == 1)
                        ...
                        <div><p class=""><a href="{{route('modification_assujetti_entreprise',$entreprise->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @else
                        <div class="p-1 m-0"><p>Non Assujetti</p></div>
                        <div><p class="text-center"><a href="{{route('modification_assujetti_entreprise',$entreprise->id)}}"><i class='bx bxs-edit-alt bx_modifier'></i></a></p></div>
                    @endif
                </div>
            </div>
            <div class="row ">
