...
<div class="col" style="margin-left: 25px">
  <a href="{{route('profil_referent')}}"> <button class="btn btn_precedent my-2 edit_pdp_cfp" ><i class="bx bxs-chevron-left"></i> Retour</button></a>
</div>
<center>
            ...
            @csrf
                    ...
                    {{-- <label class="ml-3 form-control-placeholder" style="font-size:13px;color:#801D68">Nom</label> --}}
                        ...
                        <div class="row px-3 mt-4">
                          ...
                          <input type="text" value="{{ $responsable->cin_resp}}" class="form-control test input"  name="cin" id="cin">
