...
<div class="col-lg-4">
    <div class="p-3 form-control">
        <p style="text-align: left">Departement</p>
        <form   class="btn-submit" action="{{route('update_responsable')}}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <input type="hidden" class="form-control input"  name="entreprise"  value="{{ optional(optional($ref)->entreprise)->nom_etp}}" readonly>
                    
                    <input type="hidden" value="{{ $ref->poste_resp }}"  class="form-control input"  name="poste"  readonly>
                    <div class="row px-3 mt-4">
                        <div class="form-group mt-1 mb-1">
                    <input type="text" class="form-control input"  name="departement" value="{{ optional(optional($ref)->departement)->nom_departement }}" readonly>
            
                    <label class="ml-3 form-control-placeholder" style="font-size:13px;color:#801D68">Departement</label>
