    ...
    <div class="p-3 form-control">
        ...
        <form   class="btn-submit" action="{{route('update_responsable',$responsable->id)}}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <input type="text" class="form-control test input"  name="fonction" placeholder="Fonction" value="  {{ $responsable->fonction_resp}}" >
                    <label class="ml-3 form-control-placeholder" style="">Fonction</label>
