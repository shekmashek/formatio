        ...
        <form   class="btn-submit" action="{{route('update_responsable')}}" method="post" enctype="multipart/form-data">
            @csrf
                <div class="row px-3 mt-4">
                    ...
                    <input type="text" value="   {{ $ref->nom_resp }}" class="form-control test input"  name="nom">
                    <label class="ml-3 form-control-placeholder" style="font-size:13px;color:#801D68">Nom</label>
                    </div>
                </div>
                <div class="row px-3 mt-4">
                    <div class="form-group mt-1 mb-1">
                        <input type="text" class="form-control test input" value="   {{ $ref->prenom_resp }}"  name="prenom">
                        ...
                        <select hidden value="{{$ref->sexe_resp}}" name="genre" class="form-select test" id="genre"  >
