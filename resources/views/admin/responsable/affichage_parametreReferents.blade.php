...
@section('title')
    <h3 class="text_header m-0 mt-1">Profiles Entreprises</h3>
@endsection
@section('content')
            ...
            <div class="form-control" >
                ...
                <div class="d-flex align-items-center justify-content-between hover" style="border-bottom: solid 1px #e8dfe5;">
                    ...
                    <div class="text-end">
                        ...
                        @else
                            <span class="text-end">
                                <img src="{{asset('images/entreprises/'.$entreprise->logo)}}" style="width:120px;height:60px"class="">
                            </span>
                            @endif
                        </a>
                    </div>
                ...
                <div style="border-bottom: solid 1px #e8dfe5;" class="">
                    <a href="" class="none">
                        <p class="p-1 m-0" style="font-size: 12px;">Branche<span style="float: right;">{{$branches->nom_branche}} &nbsp;<i class="fas fa-angle-right"></i></span></p>
                    </a>
                </div>
