...
@section('title')
    <h3 class="text_header m-0 mt-1">Modification module non publiée</h3>
@endsection
@section('content')
                                ...
                                <div class="form-row">
                                        ...
                                        <div class="acf-field acf-field-text acf-field-description is-required">
                                            <div class="acf-input">
                                                <div class="acf-input-wrap premier_wrap mt-1">
                                                    <input type="text"
                                                        class="form-control descript descript input mt-1"
                                    ...
                                    <div class="form-group" id="premier_vue6">
                                        <div class="acf-field acf-field-text acf-field-modalite is-required">
                                            <div class="acf-input">
                                                <div class="acf-input-wrap premier_wrap mt-1">
                                                    <select
                                                        class="form-control select_formulaire modalite modalite input mt-1"
                                    ...
                                    <div class="form-group" id="premier_vue7">
                                        <div class="acf-field acf-field-text acf-field-niveau is-required">
                                            <div class="acf-input">
                                                <div class="acf-input-wrap premier_wrap mt-1">
                                                    <select
                                                        class="form-control select_formulaire niveau niveau input mt-1"
                                            ...
                                            <div class="acf-input">
                                                <div class="acf-input-wrap">
                                                    <textarea class="form-control cible cible text_area"
                                                        id="acf-cible" name="cible" placeholder="Public Cible"
                                            ...
                                            <div class="acf-input">
                                                <div class="acf-input-wrap">
                                                    <textarea class="form-control prerequis prerequis text_area mt-3"
                                                        id="acf-prerequis" name="prerequis" placeholder="Prérequis">{{$mod->prerequis}}</textarea><label
                                                        for="acf-prerequis"
                                    ...
                                    <div class="form-group apres_preview" id="quatriem_vue2">
                                            ...
                                            <div class="acf-input">
                                                <div class="acf-input-wrap">
                                                    <input type="text" class="form-control prix_groupe prix_groupe input mt-3"
                                                        id="acf-prix" name="prix" min="0" minlength="1" maxlength="7" pattern="[0-9]{1,7}" placeholder="Prix en {{$devise->devise}}"
                                        ...
                                        <div class="acf-field acf-field-text acf-field-prix is-required">
                                            <div class="acf-input">
                                                <div class="acf-input-wrap">
                                                    <input type="text" class="form-control prix prix input mt-4" id="acf-prix" name="prix_groupe" min="0" minlength="1" maxlength="7" pattern="[0-9]{1,7}" placeholder="Prix par Groupe en {{$devise->devise}}" value="{{$mod->prix_groupe}}" onfocus="(this.type='number')">
                                            ...
                                            <div class="acf-input">
                                                <div class="acf-input-wrap">
                                                    <input type="text"
                                                        ...
                                                        id="acf-materiel" name="materiel" placeholder="Equipement Nécessaire"
                                    ...
                                    <div class="form-group apres_preview" id="cinquiem_vue2">
                                        <div class="acf-field acf-field-text acf-field-bon_a_savoir is-required">
                                            <div class="acf-input">
                                                <div class="acf-input-wrap">
                                                    <textarea
                                                        class="form-control bon_a_savoir bon_a_savoir text_area mt-3" placeholder="Bon à Savoir"
                                    ...
                                    <div class="form-group mb-5 apres_preview" id="sixieme_vue2">
                                                        ...
                                                        <div class="acf-input">
                                                            <div class="acf-input-wrap">
                                                                <input type="text"
                                                                    ...
                                                                    value="{{$mod->min_pers}}"
                                                                    onfocus="(this.type='number')" placeholder="Nombre personne
                                                                    min"
                                                                    title="entrer le nombre de personne minimale"><label
                                                                    for="acf-min"
                                                        ...
                                                        <div class="acf-input">
                                                            <div class="acf-input-wrap">
                                                                <input type="text"
                                                                    ...
                                                                    value="{{$mod->max_pers}}"
                                                                    onfocus="(this.type='number')" placeholder="Nombre personne
                                                                    max" title="entrer le nombre de personne maximale"><label
                                                                    for="acf-max"
                                                                    class="form-control-placeholder">Nombre personne
                                                                    max</label>
                                                            </div>
                                        ...
                                        <div class="col text-center">
                                            <p class="mt-3" style="font-size: 16px;"><a href="#changer_prestation"
                                                ...
                                                onclick="retour_equipement();">Precedent</a></p>
                                        </div>
                                    </div>
                        ...
                        <div class="row  bg-light justify-content-space-between py-3 px-5"
                                ...
                                <div class="detail__formation__result__item ">
                                    <h4>
                                        <span id="preview_module">
                                            <span class="acf-nom_module">Excel avancee</span>
                                        </span><br>
                            ...
                            <div
                                ...
                                <div class="col" id="preview_modalite"><i class="bx bxs-devices bx_icon"
                                        style="color: #7635dc !important;"></i>&nbsp;<span class="acf-modalite">En ligne/Presentiel</span>
                                </div>
                            ...
                            <div class="col-lg-4 detail__formation__item__right" id="border_reference">
                                ...
                                <div class="row detail__formation__item__rmain">
                                    ...
                                    <div class="col-lg-7 detail__prix__main__prix2">
                                        <div>
                                            <p id="preview_prix"><span class="acf-prix">450000</span>&nbsp;{{$devise->devise}}&nbsp;HT
                                            </p>
                                        </div>
                                    </div>
                                </div>
