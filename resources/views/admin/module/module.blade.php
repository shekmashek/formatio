    ...
    <div class="container-fluid pb-3">
        ...
        <div class="m-4">
            <ul class="nav nav-tabs d-flex flex-row navigation_module" id="myTab">
                <li class="nav-item">
                    <a href="#enCours" class="nav-link active" data-bs-toggle="tab">En cours de creation&nbsp;(3)</a>
                </li>
                <li class="nav-item">
                    <a href="#nonPublies" class="nav-link" data-bs-toggle="tab">Non publiées&nbsp;(5)</a>
                </li>
                <li class="nav-item">
                    <a href="#publies" class="nav-link" data-bs-toggle="tab">Publiées&nbsp;(7)</a>
                </li>
            </ul>
