                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group apres_preview" id="second_vue">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <p class="text-center mt-3" style="font-size: 16px"><button type="button"
                                                    class="new_list_nouvelle px-5 btn_previous"
                                                    onclick="retour_module();"><a
                                            ...
                                            <div class="acf-input">
                                                <div class="acf-input-wrap">
                                                    <textarea class="form-control prerequis prerequis text_area mt-3"
                                                        id="acf-prerequis" name="prerequis" placeholder="Prérequis"
                                                        required>{{$mod->prerequis}}</textarea><label
                                                        for="acf-prerequis"
                                    ...
                                    <div class="form-group apres_preview" id="quatriem_vue">
                                        <div class="acf-field acf-field-text acf-field-reference is-required">
                                            <div class="acf-input">
                                                <div class="acf-input-wrap">
                                                    <input type="text" class="form-control reference reference input"
                                                        id="acf-reference" name="reference" value="{{$mod->reference}}"
                                                        placeholder="Reference" required><label for="acf-reference"
                                    ...
                                    <div class="form-group apres_preview" id="quatriem_vue2">
                                            ...
                                            <div class="acf-input">
                                                <div class="acf-input-wrap">
                                                    <input type="text" class="form-control prix prix input  mt-3"
                                                        ...
                                                        placeholder="Prix en {{$devise->devise}}" required><label for="acf-prix"
                                                        class="form-control-placeholder">Prix en {{$devise->devise}}</label>
                                                    @error('prix')
                                                    <div class="col-sm-6">
                                                        <span style="color:#ff0000;"> {{$message}} </span>
                                                    </div>
                                        ...
                                        <div class="acf-field acf-field-text acf-field-prix is-required">
                                            <div class="acf-input">
                                                <div class="acf-input-wrap">
                                                    <input type="text" class="form-control prix_groupe prix_groupe input mt-4" id="acf-prix_groupe" name="prix_groupe" min="0" minlength="1" maxlength="7" pattern="[0-9]{1,7}" placeholder="Prix par Groupe en {{$devise->devise}}" value="{{$mod->prix_groupe}}" onfocus="(this.type='number')" onkeyup='estComplet();'>
                                    ...
                                    <div class="form-group apres_preview" id="cinquiem_vue">
                                        <div class="acf-field acf-field-text acf-field-materiel is-required">
                                            <div class="acf-input">
                                                <div class="acf-input-wrap">
                                                    <input type="text" class="form-control materiel materiel input"
                                                        id="acf-materiel" name="materiel"
                                                        value="{{$mod->materiel_necessaire}}"
                                                        placeholder="Equipement Nécessaire" required><label
                                                        for="acf-materiel" class="form-control-placeholder">Equipement
                                                        Nécessaire</label>
                                                    @error('materiel')
                                                    <div class="col-sm-6">
                                                        <span style="color:#ff0000;"> {{$message}} </span>
                                            ...
                                            <div class="acf-input">
                                                <div class="acf-input-wrap">
                                                    <textarea
                                                        ...
                                                        placeholder="Bon à Savoir"
                                                        required>{{$mod->bon_a_savoir}}</textarea><label
                                                        for="acf-bon_a_savoir"
                                                        class="form-control-placeholder-text_area">Bon à Savoir</label>
                                                    @error('bon_a_savoir')
                                                    <div class="col-sm-6">
                                                        <span style="color:#ff0000;"> {{$message}} </span>
                                                    </div>
                                    ...
                                    <div class="form-group apres_preview" id="sixieme_vue">
                                        <div class="acf-field acf-field-text acf-field-prestation is-required">
                                            <div class="acf-input">
                                                <div class="acf-input-wrap">
                                                    <textarea class="form-control prestation prestation text_area"
                                                        id="acf-prestation" name="prestation" onkeyup='estComplet();'
                                                        placeholder="Préstation Pédagogiques"
                                                        required>{{$mod->prestation}}</textarea><label
                                                        for="acf-bon_a_savoir"
                                                        class="form-control-placeholder-text_area">Préstation
                                                        Pédagogiques</label>
                                                    @error('prestation')
                                                    <div class="col-sm-6">
                                                        <span style="color:#ff0000;"> {{$message}} </span>
                                    ...
                                    <div class="form-group mb-5 apres_preview" id="sixieme_vue2">
                                                ...
                                                <div class="form-group" id="premier_">
                                                    <div class="acf-field acf-field-text acf-field-miin is-required">
                                                        <div class="acf-input">
                                                            <div class="acf-input-wrap">
                                                                <input type="text"
                                                                    class="form-control min min input mt-3" id="acf-min"
                                                ...
                                                <div class="form-group" id="premier_">
                                                    <div class="acf-field acf-field-text acf-field-max is-required">
                                                        <div class="acf-input">
                                                            <div class="acf-input-wrap">
                                                                <input type="text"
                                                                    class="form-control max max input mt-3" id="acf-max"
                                                                    name="max_pers" min="1" max="100"
                                                                    value="{{$mod->max_pers}}"
                                                                    onfocus="(this.type='number')"
                                        ...
                                        <div class="col text-center">
                                            <p class="mt-3" style="font-size: 16px;"><a href="#changer_prestation"
                                                    type="button" class="new_list_nouvelle btn_next px-5"
                                                    onclick="retour_prestation();">Precedent</a></p>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-lg-7 detail__prix__main__prix2">
                                                    <div>
                                                        <p id="preview_prix"><span
                                                                class="acf-prix">450000</span>&nbsp;{{$devise->devise}}&nbsp;HT
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
