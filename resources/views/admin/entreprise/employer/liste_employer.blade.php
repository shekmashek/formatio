                ...
                <table id="example" class="table " style="width:100%">
                    <thead>
                        <tr>
                            ...
                            @can('isReferent')
                            <th scope="col" class="table-head font-weight-light align-middle text-center ">Formateur
                                interne</th>
                    ...
                    <tbody>
                        @for ($i = 0;$i < count($employers);$i++ ) <tr>
                            <td class="align-middle id empNew" data-id={{$employers[$i]->user_id}}
                                id={{$employers[$i]->user_id}} onclick="afficherInfos();" style="cursor: pointer">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    {{-- <i class='bx bx-user-circle  h1' style='
                                                        @if ($employers[$i]->activiter == 1) color:#25b900c9;' @else
                                        color:#e21717;' @endif></i> --}}

                                    {{-- initials --}}
                                    <div class="randomColor rounded-circle p-3 mb-2 profile-circle">
                                        <span class="align-middle text-center profile-initial"
                                            style="position:relative;">
                                            <b data-id={{$employers[$i]->user_id}} id={{$employers[$i]->user_id}}
                                                onclick="afficherInfos();" class="empNew" style="cursor:
                                                pointer">{{substr($employers[$i]->nom_stagiaire, 0, 1)}}
                                                {{substr($employers[$i]->prenom_stagiaire, 0, 1)}}</b>
                                        </span>
                                    </div>
                                    @else


                                    <img data-id={{$employers[$i]->user_id}} id={{$employers[$i]->user_id}}
                                    onclick="afficherInfos();" src="{{ asset('images/employes/' .
                                    $employers[$i]->photos) }}"
                                    ...
                                    @endif
                                    <div class="ms-3">
                                        <p class="fw-normal mb-1 text-purple empNew" data-id={{$employers[$i]->user_id}}
                                            id={{$employers[$i]->user_id}} onclick="afficherInfos();" style="cursor:
                                            pointer">
                                            {{--
                                        <p class="fw-bold mb-1 text-purple "> --}}
                                            {{ $employers[$i]->nom_stagiaire }} {{ $employers[$i]->prenom_stagiaire }}
                                        </p>
                                        <p class="text-muted mb-0 empNew" data-id={{$employers[$i]->user_id}}
                                            id={{$employers[$i]->user_id}} onclick="afficherInfos();" style="cursor:
                                            pointer">{{ $employers[$i]->fonction_stagiaire }}</p>
                                    </div>
                                </div>
                            </td>

                            <td class="align-middle text-start empNew" data-id={{$employers[$i]->user_id}}
                                id={{$employers[$i]->user_id}} onclick="afficherInfos();" style="cursor: pointer">
                                        ...
                                        <table id="modifTable" class="table">
                                            <thead style="position: sticky; top: 0; background: #c7c9c939">
                                                <tr>
                                                    <th class="id">ID</th>
                                                    <th scope="col"
                                                        class="table-head font-weight-light align-middle text-center ">
                                                        Employé</th>
                                                    <th scope="col"
                                                        class="table-head font-weight-light align-middle text-center ">
                                                        Contacts</th>
                                            ...
                                            <tbody>
                                                @for ($i = 0;$i < count($employers);$i++ ) <tr>
                                                    <td class="align-middle id empNew" data-id={{$employers[$i]->
                                                        user_id}} id={{$employers[$i]->user_id}}
                                                        onclick="afficherInfos();" style="cursor: pointer">
                                                        @if ($employers[$i]->activiter == 1)
                                                        <span style="color:#00b900; "> <i class="bx bxs-circle"></i>
                                                        </span>
                                                        @else
                                                        <span style="color:red; "> <i class="bx bxs-circle"></i> </span>
                                                        @endif
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            @if ($employers[$i]->photos == null)
                                                            <div
                                                                class="randomColor rounded-circle p-3 mb-2 profile-circle">
                                                                <span class="align-middle text-center profile-initial"
                                                                    style="position:relative;">
                                                                    <b data-id={{$employers[$i]->user_id}}
                                                                        id={{$employers[$i]->user_id}}
                                                                        onclick="afficherInfos();" class="empNew"
                                                                        style="cursor:
                                                                        pointer">{{substr($employers[$i]->nom_stagiaire,
                                                                        0, 1)}}
                                                                        {{substr($employers[$i]->prenom_stagiaire, 0,
                                                                        1)}}</b>
                                                                </span>
                                                            </div>
                                                            @else
                                                            <img data-id={{$employers[$i]->user_id}}
                                                            id={{$employers[$i]->user_id}} onclick="afficherInfos();"
                                                            src="{{ asset('images/employes/' . $employers[$i]->photos)
                                                            }}"
                                                            alt="Image non chargée" style="width: 45px; height: 45px;
                                                            cursor: pointer"
                                                            class="rounded-circle empNew" />
                                                            @endif
                                                            <div class="ms-3">
                                                                <p class="fw-normal mb-1 text-purple empNew"
                                                                    data-id={{$employers[$i]->user_id}}
                                                                    id={{$employers[$i]->user_id}}
                                                                    onclick="afficherInfos();" style="cursor: pointer">
                                                                    {{ $employers[$i]->nom_stagiaire }} {{
                                                                    $employers[$i]->prenom_stagiaire }}</p>
                                                                <p class="text-muted mb-0 empNew"
                                                                    data-id={{$employers[$i]->user_id}}
                                                                    id={{$employers[$i]->user_id}}
                                                                    onclick="afficherInfos();" style="cursor:
                                                                    pointer">{{ $employers[$i]->fonction_stagiaire }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </td>

                                                    <td class="align-middle text-start empNew"
                                                        data-id={{$employers[$i]->user_id}}
                                                        id={{$employers[$i]->user_id}} onclick="afficherInfos();"
                                                        style="cursor: pointer">
                                                        <div class="ms-3">
                                                            <p class="mb-1 text-purple">{{
                                                                $employers[$i]->mail_stagiaire }}</p>
                                                            <p class="text-muted mb-0">
                                                                {{ $employers[$i]->telephone_stagiaire != null ?
                                                                $employers[$i]->telephone_stagiaire : '----' }}
                                                            </p>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle text-center text-secondary">
                                                        <p class="text-muted mb-0">
                                                            @if($employers[$i]->nom_departement == null OR
                                                            $employers[$i]->nom_service == null)
                                                            Non catégorisé
                                                            @else
                                                    ...
                                                    <td class="align-middle text-center text-secondary">
                                                        @if($employers[$i]->activiter == 1)
                                                        @if($form_int[$i] == 1)
                                                        <input class="form-check-input formateur_interne"
                                                            type="checkbox" value="{{$employers[$i]->id}}"
                                                            name="referent" id="flexCheckDefault" checked>
                                                        @else
                                                        <input class="form-check-input formateur_interne"
                                                            type="checkbox" value="{{$employers[$i]->id}}"
                                                            name="formateurinterne" id="flexCheckDefault">
                                                        @endif
                                                        @endif
                                                        @if($employers[$i]->activiter == 0)
                                                        <input disabled class="form-check-input formateur_interne"
                                                            type="checkbox" value="{{$employers[$i]->id}}"
                                                            name="formateurinterne" id="flexCheckDefault">
                                                        @endif
                                                    </td>
                                                    <td class="align-middle text-center text-secondary">
                                                        @if($employers[$i]->activiter == 1)
                                                        @if($ref[$i] == 1)
                                                        <input class="form-check-input referent" type="checkbox"
                                                            value="{{$employers[$i]->id}}" name="referent"
                                                        ...
                                                        @endif
                                                        @if($employers[$i]->activiter == 0)
                                                        <input disabled class="form-check-input referent"
                                                            type="checkbox" value="{{$employers[$i]->id}}"
                                                            name="referent" id="flexCheckDefault">
                                                        @endif
                                                    </td>
                                                    @endcan
                                                    <td class="align-middle text-center text-secondary">
                                                        ...
                                                        <div class="form-check form-switch">
                                                            <label class="form-check-label"
                                                                for="flexSwitchCheckChecked"><span
                                                                    class="badge bg-success">actif</span></label>
                                                            @can('isReferent')
                                                            <input class="form-check-input desactiver_stg"
                                                                type="checkbox"
                                                                data-user-id="{{ $employers[$i]->user_id }}"
                                                                value="{{ $employers[$i]->id }}" checked>
                                                            @endcan
                                                        </div>
                                                        @else
                                                        <div class="form-check form-switch">
                                                    ...
                                                    <div class="modal fade" id="delete_emp_{{ $employers[$i]->id }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered"
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header d-flex justify-content-center"
                                                                        ...
                                                                        <h4 class="modal-title text-white">Avertissement
                                                                            !</h4>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <small>Vous êtes sur le point d'enlever
                                                                            l'employé
                                                                            {{ $employers[$i]->nom_stagiaire }} {{
                                                                            $employers[$i]->prenom_stagiaire }},
                                                                            cette action est irréversible. Continuer
                                                                            ?</small>
                                                                    </div>
                                                                    <div class="modal-footer justify-content-center">
                                                                        <button type="button" class="btn btn_creer"
                                                                            data-bs-dismiss="modal"> Non
                                                                        </button>
                                                                        <a
                                                                            href="{{ route('employeur.destroy', $employers[$i]->user_id) }}">
                                                                            <button type="button"
                                                                                class="btn btn_creer btnP px-3">Oui</button></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
                                        ...
                                        <div class="mt-2" style="font-size:14px">
                                            {{-- <div class="mt-1">
                                                <span class="text-center" style="height: 50px; width: 100px"><img
                                                        src="{{asset('images/CFP/'.$centre->logo_cfp)}}"
                                                        alt="Logo"></span>
                                            </div> --}}
                                            ...
                                            {{-- <div class="mt-1 mb-3 text-center">
                                                <span id="prenom"
                                                    style="font-size: 16px; text-transform: capitalize; font-weight: bold"></span>
                                            </div> --}}
                                            <div class="mt-1">
                                                <div class="row">
