...
@section('title')
    <h3 class="text_header m-0 mt-1">Modification site web</h3>
@endsection
@section('content')
...
<center>
    ...
    <div class="col-lg-4">
        <div class="p-3 form-control">
            <form   class="btn-submit" action="{{route('enregistrer_site_etp_entreprise',$etp->id)}}" method="post" enctype="multipart/form-data">
                @csrf
