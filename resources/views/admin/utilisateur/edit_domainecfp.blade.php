...
<div class="col-lg-4">
    <div class="p-3 form-control">
        <p style="text-align: left">Domaine de formation</p>
        <form   class="btn-submit" action="{{route('utilisateur_update_cfp',$cfp->id)}}" method="post" enctype="multipart/form-data">
            @csrf
                  ...
                  <input class="form-control test"  type="hidden" name="mail" value="{{ $cfp->email }}">
                    ...
                    <input type="text" class="form-control test input"  name="domaine_cfp" placeholder="Fonction" value="  {{ $cfp->domaine_de_formation }}" >
                    <label class="ml-3 form-control-placeholder" style="font-size:13px;color:#801D68">Domaine de formation</label>
                        </div>
                    </div>
