...
@section('title')
    <h3 class="text_header m-0 mt-1">Responsable de centre de formation professionnel</h3>
@endsection
@section('content')
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="width: 10%;"><a class="dropdown-item" href="{{ route('profil_du_responsable',$resp->id) }}">
                                ...
                                <img class="img-fluid " alt="Responsive image" src="{{asset('images/responsables/users.png')}}"  style="width:50px;height:50px;border-radius:100%" cellspacing="0"> </a>

                            @else

                            <img class="img-fluid " alt="Responsive image" src="{{asset('images/responsables/'.$resp->photos_resp_cfp)}}" style="width:50px;height:50px;border-radius:100%" cellspacing="0"> </a>
                            @endif
                        </td>
