            ...
            @csrf
                ...
                <div class="row px-3 mt-4">
                    <div class="form-group mt-1 mb-1">
                        <input type="text" class="form-control test input" name="adresse_lot"  value="  {{ $cfp->adresse_lot }}" >
                ...
                <div class="row px-3 mt-4">
                    <div class="form-group mt-1 mb-1">
                        <input type="text" value="  {{ $cfp->adresse_ville}}" class="form-control test input"  name="adresse_ville" >
                ...
                <div class="row px-3 mt-4">
                    <div class="form-group mt-1 mb-1">
                        <input type="text" class="form-control test input"  name="adresse_region" value="  {{ $cfp->adresse_region }}" >
