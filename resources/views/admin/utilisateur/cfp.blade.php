...
<div class="container-fluid">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                {{-- <td colspan="3" style="width: 40px;"><a class="dropdown-item" href="{{ route('profil_du_responsable',$resp->id) }}"> <img alt="Responsive image" class="logo_responsable" src="{{asset('images/CFP/'.$resp->logo)}}" cellspacing="0"> </a></td> --}}

                <td colspan="3" ><a class="dropdown-item" href=""> <img class="logo_responsable" alt="Responsive image" src="{{asset('images/CFP/'.optional(optional($resp)->cfp)->logo)}}"> </a></td>
