...
<div class="col-lg-4">
    <div class="p-3 form-control">
        ...
        <form   class="btn-submit" action="{{route('update_logo_cfp',$cfp->id)}}" method="post" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="image-upload">
                          <label for="file-input">
                            <div class="upload-icon profilepic">
                                <img src="/dynamic-image/{{$cfp->logo}}" id = "photo_stg"  class="image-ronde  profilepic__image"> 
