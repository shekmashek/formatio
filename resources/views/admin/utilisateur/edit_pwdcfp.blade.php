...
<div class="col-lg-4">
    <div class="p-3 form-control">
        ...
        <form   class="btn-submit" action="{{route('update_cfp_mdp',$cfp->id)}}" method="post" enctype="multipart/form-data">
            @csrf
                
                    <input type="hidden" value="   {{ optional(optional($cfp)->user)->name}} }}" class="form-control test input"  name="nom">
