...
<div class="col-lg-4">
    <div class="p-3 form-control">
        ...
        <form   class="btn-submit" action="{{route('update_mail_cfp',$cfp->id)}}" method="post" enctype="multipart/form-data">
            @csrf
                  ...
                  <input class="form-control test input"  type="text" name="mail" value="{{ $cfp->email }}">
