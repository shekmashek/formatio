...
<div class="container-fluid">
    <div class="shadow p-5 mb-5 mx-auto bg-body w-50 mt-5" style="border-radius: 15px">
            ...
            @endif
            <form action="{{route('enregistrer_modification_abonnement_etp',$abonnement->id)}}" method="POST">
                @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="row px-3">
                                <div class="form-group">
                                    <select class="form-select selectP input" id="type_abonne" name="type_abonne" aria-label="Default select example">
                                        <option value="of">Entreprise</option>
                                    </select>
                    ...
                    <div class="row  mt-4">
                        <div class="col-4">
                            <div class="row px-3">
                                <div class="form-group">
                                    <input type="number" class="form-control input" min="1" id="min_emp" name="min_emp" value="{{$abonnement->min_emp}}"/>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <input type="number" class="form-control input" id="max_emp" name="max_emp" value="{{$abonnement->max_emp}}"/>
