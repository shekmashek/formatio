                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item mx-1">
                                @can('isStagiaire')
                                <a class="nav-link btn_enregistrer  {{ Route::currentRouteNamed('liste_demande_formation') ? 'active' : '' }}" aria-current="page" href="{{route('liste_demande_formation')}}">
                                    Liste de demande
                                </a>
                                @endcan
                                @can('isReferent')
                                <a class="nav-link btn_enregistrer {{ Route::currentRouteNamed('liste_demande_stagiaire') ? 'active' : '' }}" aria-current="page" href="{{route('liste_demande_stagiaire')}}">
                                    Liste de demande
                                </a>
                                @endcan
                            ...
                            <li class="nav-item mx-1">
                                <a class="nav-link btn_enregistrer {{ Route::currentRouteNamed('planFormation.index') ? 'active' : '' }}" aria-current="page" href="{{route('planFormation.index')}}">
                                    Nouvelle demande</a>
                            </li>
