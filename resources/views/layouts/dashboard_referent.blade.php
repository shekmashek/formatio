...
<div class=" p-0 m-0 nav d-flex flex-row navigation justify-content-end" style="font-size: 10px;">
    <a href="{{ route('home') }}" type="button" class="btn a active" style="font-size: 12px;"> <i
            class="fad fa-sliders-v" style="font-size: 10px;"></i>&nbsp;TDB système</a>
    <a href="{{ route('homertdbf')}}" type="button" class="btn  me-2 ms-2" style="font-size: 12px;"><i
            class="far fa-chart-line" style="font-size: 10px;"></i>&nbsp;TDB financier</a>
    <a href="{{ route('homertdbq')}}" type="button" class="btn " style="font-size: 12px;"> <i class="fad fa-chart-bar"
            style="font-size: 10px;"></i>&nbsp;TDB qualité</a>
</div>
...
<div class="p-1 m-0">
    <div class="container-fluid" style="font-size: 10px;">
        <div class="row mt-2">
            <div class="col-lg-4">
                <div class="shadow-sm p-2 mb-1 bg-body rounded" style="color: #801D68"><b> <i
                            class="fad fa-users "></i>&nbsp; Collaborateur </b>
            ...
            <div class="col-lg-4">
                <div class="shadow-sm p-2 mb-1 bg-body rounded" style="color: #801D68"><b> <i
                            class="far fa-book-spells"></i> &nbsp; Catalogue </b>
            ...
            <div class="col-lg-4">
                <div class="shadow-sm p-2 mb-1 bg-body rounded" style="color: #801D68"><b> <i
                            class="fad fa-address-card"></i>&nbsp; Facture </b>
    ...
    <div class="container-fluid" style="font-size: 10px;">
        <div class="row mt-2">
            <div class="col-lg-4">
                <div class="shadow-sm p-2 mb-1 bg-body rounded" style="color: #801D68"><b> <i class="fas fa-tasks"></i>
                        &nbsp; Session Inter entreprise </b>
            ...
            <div class="col-lg-4">
                <div class="shadow-sm p-2 mb-1 bg-body rounded" style="color: #801D68"><b> <i
                            class="fas fa-tasks"></i>&nbsp; Session Intra enreprise </b>
                    <p class="p-0 m-1 system_ pb-1">Complété<span class="system_numero">3</span></p>
                    <p class="m-1 system_ pb-1">Prévisionnel<span class="system_numero">0</span></p>
            ...
            <div class="col-lg-4">
                <div class="shadow-sm p-2 mb-1 bg-body rounded" style="color: #801D68"><b> <i
                            class="fal fa-building"></i> &nbsp; Profil de l'organisation (Numerika) </b>
                    <p class="p-0 m-1 system_ pb-1">Adresse<span class="system_numeroAlert">Incomplet</span></p>
                    <p class="m-1 system_ pb-1">Information légale<span class="system_numeroSuccess">complet</span>
                    </p>
    ...
    <div class="container-fluid" style="font-size: 10px;">
        <div class="row mt-2">
            <div class="col-lg-4">
                <div class="shadow-sm p-2 mb-1 bg-body rounded" style="color: #801D68"><b><i
                            class="far fa-user-cog"></i>&nbsp; Profil de l'utilisateur (Urluc) </b>
                    <p class="p-0 m-1 system_ pb-1">Informations générales<span
                            class="system_numeroAlert">Incomplet</span></p>
                    <p class="m-1 system_ pb-1">Coordonnées<span class="system_numeroSuccess">Complet</span></p>
                    <p class="m-1 system_ pb-1">Informations professionnelles<span
                            class="system_numeroAlert">Incomplet</span></p>
                </div>
            </div>
        </div>
