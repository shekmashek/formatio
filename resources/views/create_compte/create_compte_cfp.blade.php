                ...
                <div id="formulaire" class="mt-0">
                    ...
                    <fieldset class="shadow mt-0 p-3 bg-body rounded  field-cfp">
                            <div class="form-group mb-2">
                                <div class="row">
                                    <div class="col-4">
                                        <label for="name_cfp" class="text-start mb-2">Raison Sociale<span style="color:#ff0000;">*</span></label>
                                    </div>
                                    <div class="col-8">
                                        <input type="text" name="name_cfp" class="form-control input" id="name_cfp" placeholder="Nom de votre organisme*" required/>
                                        @error('name_cfp')
                                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                   <div class="col-4">
                                    <label for="name_entreprise" class="">NIF<strong style="color:#ff0000;">*</strong></label>
                                   </div>
                                   <div class="col-8">
                    ...
                    <fieldset class="shadow p-3 bg-body rounded field2-cfp">
                        <h6 align="left" class="mb-2 a_proposdeVous">Â propos de vous</strong></h4>
