    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-md-5 ">
                ...
                <p class="mt-0">Vous avez un compte? Connectez-vous <a href="{{route('sign-in')}}" style="color: blue">ICI.</a> Vous voulez revenir à l'accueil?  Appuyez sur <a href="{{route('create+compte+client')}}" style="color: blue">accueil</a></p>
