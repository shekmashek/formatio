...
-- FROM
--     v_role_user_init,
--     role_users,stagiaires
-- WHERE
--     v_role_user_init.user_id = role_users.user_id AND v_role_user_init.id = role_users.role_id and
--     GROUP BY id,role_name,created_at,updated_at,role_description,user_id
--   ;

--  assigner role user de l'entreprise pour les stagiaires

-- CREATE OR REPLACE VIEW v_role_not_user_etp AS SELECT
--     v_role_user_init.*
-- FROM
--     v_role_user_init,
--     role_users
-- WHERE
--     v_role_user_init.user_id = role_users.user_id AND v_role_user_init.id != role_users.role_id
--     GROUP BY id,role_name,created_at,updated_at,role_description,user_id
--     ;

--     CREATE OR REPLACE VIEW v_role_user_etp AS SELECT
--     v_role_user_init.*
-- FROM
--     v_role_user_init,
--     role_users
