...
CREATE TABLE users (
  ...
  telephone varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL UNIQUE,
...
(1, 'Nicole', 'contact@formation.mg', NULL, '$2y$10$9i0uUmJpIwVtYX1dlEdM5.bNcYXU8CrD8QXDS5loPVAurII6BmbFm', NULL, '2021-08-04 05:53:44', '2021-08-04 05:53:44', 6,'301051027178','0321122233');
...
CREATE TABLE cfps (
  ...
  stat varchar(191) COLLATE utf8mb4_unicode_ci,
  rcs varchar(191) COLLATE utf8mb4_unicode_ci,
  cif varchar(191) COLLATE utf8mb4_unicode_ci,
  created_at timestamp NULL DEFAULT NULL,
  updated_at timestamp NULL DEFAULT NULL,
  logo varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE responsables_cfp(
  ...
  adresse_lot varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT 'XXXXXXXX',
  adresse_quartier varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT 'XXXXXXXX',
  adresse_code_postal varchar(3) COLLATE utf8mb4_unicode_ci  DEFAULT 'XXX',
  adresse_ville varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT 'XXXXXXXX',
  adresse_region varchar(191) COLLATE utf8mb4_unicode_ci  DEFAULT 'XXXXXXXX',
