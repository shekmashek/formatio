...
class NouveauCompte extends Model
{
    ...
    public function validation_form_cfp($imput)
    {
      //  'logo_cfp.max' => 'la taille de votre image ne doit pas dépassé 60 Ko',
        ...
        $rules = [
            'name_cfp.required' => 'la raison sociale de votre entreprise ne doit pas être nulle',
            'nif.required' => 'le NIF de votre entreprise ne doit pas être nul',
            'logo_cfp.required' => 'le logo de votre entreprise ne doit pas être nul',
            'logo_cfp.file' => 'le logo de votre entreprise doit être de type "file"',
            'logo_cfp.max' => 'la taille de votre image ne doit pas dépassé 1.7 MB',
            'logo_cfp.mimes' => 'votre logo doit être soit "*.png, *.jpg, *.jpeg"',
            'nom_resp_cfp.required' => 'le Nom de votre responsable ne doit pas être nul',
            'cin_resp_cfp.required' => 'le CIN de votre responsable ne doit pas être nul',
            'email_resp_cfp.required' => 'votre e-mail ne doit pas être nul',
            'email_resp_cfp.email' => 'votre e-mail doit être contenir "@" !'
        ];
        $critereForm = [
            'name_cfp' => 'required',
            'nif' => 'required',
