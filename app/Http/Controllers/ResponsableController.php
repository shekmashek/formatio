...
class ResponsableController extends Controller
{
    ...
    public function affReferent($id = null)
    {
        if (Gate::allows('isReferent')) {
            ...
            return view('admin.responsable.profilResponsables', compact('ref'));
        }
    ...
    public function edit_nom($id, Request $request){
        ...
        return view('admin.participant.edit_nom', compact('responsable'));
    }
    public function edit_naissance($id, Request $request){
        $user_id =  $users = Auth::user()->id;
        $responsable_connecte = responsable::where('user_id', $user_id)->exists();
        $responsable = responsable::findOrFail($id);
        return view('admin.participant.edit_naissance', compact('responsable'));
    }
    public function edit_genre($id, Request $request){
        $user_id =  $users = Auth::user()->id;
        $responsable_connecte = responsable::where('user_id', $user_id)->exists();
        $responsable = responsable::findOrFail($id);
        return view('admin.participant.edit_genre', compact('responsable'));
    }
    public function edit_mail($id, Request $request){
        $user_id =  $users = Auth::user()->id;
        $responsable_connecte = responsable::where('user_id', $user_id)->exists();
        $responsable = responsable::findOrFail($id);
        return view('admin.participant.edit_mail', compact('responsable'));
    ...
    public function edit_phone($id, Request $request){
        ...
        $responsable_connecte = responsable::where('user_id', $user_id)->exists();
        $responsable = responsable::findOrFail($id);
        return view('admin.participant.edit_phone', compact('responsable'));
    }
    public function edit_cin($id, Request $request){
        $user_id =  $users = Auth::user()->id;
        $responsable_connecte = responsable::where('user_id', $user_id)->exists();
        $responsable = responsable::findOrFail($id);
        return view('admin.participant.edit_cin', compact('responsable'));
    }
    public function edit_adresse($id, Request $request){
        $user_id =  $users = Auth::user()->id;
        $responsable_connecte = responsable::where('user_id', $user_id)->exists();
        $responsable = responsable::findOrFail($id);
        return view('admin.participant.edit_adresse', compact('responsable'));
    }
    public function edit_fonction($id, Request $request){
        $user_id =  $users = Auth::user()->id;
        $responsable_connecte = responsable::where('user_id', $user_id)->exists();
        $responsable = responsable::findOrFail($id);
        return view('admin.participant.edit_fonction', compact('responsable'));
    }
    ...
    public function edit_entreprise($id, Request $request){
        ...
        $responsable_connecte = responsable::where('user_id', $user_id)->exists();
        $responsable = responsable::findOrFail($id);
        return view('admin.participant.edit_entreprise', compact('responsable'));
    }
    public function edit_niveau($id, Request $request){
        $user_id =  $users = Auth::user()->id;
        $responsable_connecte = responsable::where('user_id', $user_id)->exists();
        $responsable = responsable::findOrFail($id);
        return view('admin.participant.edit_niveau', compact('responsable'));
    }
    ...
    //     $responsable_connecte = responsable::where('user_id', $user_id)->exists();
    //     $responsable = responsable::findOrFail($id);
    //     return view('admin.participant.edit_departement', compact('responsable','liste_dep'));
    // }
    public function edit_branche($id, Request $request){
        $user_id =  $users = Auth::user()->id;
        $responsable_connecte = responsable::where('user_id', $user_id)->exists();
        $responsable = responsable::findOrFail($id);
        return view('admin.participant.edit_branche', compact('responsable'));
    }
    public function edit_photos($id, Request $request){
        $user_id =  $users = Auth::user()->id;
        $responsable_connecte = responsable::where('user_id', $user_id)->exists();
        $responsable = responsable::findOrFail($id);
        return view('admin.participant.edit_photos', compact('responsable'));
    }
    public function edit_pwd($id, Request $request){
        $user_id =  $users = Auth::user()->id;
        $responsable_connecte = responsable::where('user_id', $user_id)->exists();
        $responsable = responsable::findOrFail($id);
        return view('admin.participant.edit_pwd', compact('responsable'));
    }
