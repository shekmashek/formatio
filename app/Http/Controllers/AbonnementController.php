        ...
        if (Gate::allows('isReferent')) {
            ...
            if($etp_ab!=null){
                ...
                if($etp_ab[0]->nom_type == "Gratuit") {
                   //si l'utilisateur a encore choisi Gratuit
                    ...
                    //s'il a choisi un autre type, il peut effectuer l'abonnnemennt sans attendre un mois
                    else{

                    }
                }
                //si le dernier abonnement choisi n'est pas "gratuit", il doit attendre un mois avant de pouvoir s'abonner à un autre offre
                else{
